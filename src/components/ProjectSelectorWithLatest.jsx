...
const ProjectSelectorWithLatest = ({ selectedProject, selectedPlant, onProjectSelect }) => {
  ...
  const handleSelectionChange = (event) => {
    ...
    if (value === "_recents_header" || value === "_latest_header") {
      return;
    }
...
export default ProjectSelectorWithLatest;
