...
import { L as LogicalFilterOperator, I as InputState } from './p-BH3f5fa3.js';
import { f as iconClear, g as iconSearch } from './p-taILGXkr.js';
import { m as makeRef } from './p-bcj7UEIC.js';
import { a as addDisposableEventListener } from './p-kY0vP3rC.js';
import { b as a11yHostAttributes } from './p-Bb7pDeaQ.js';
import { d as defineCustomElement$5 } from './p-Bdgt58Io.js';
import { d as defineCustomElement$4 } from './p-dQmgsfMb.js';
...
const CategoryFilter = /*@__PURE__*/ proxyCustomElement(class CategoryFilter extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    getResetButton() {
        return (h("ix-icon-button", { onClick: (e) => this.resetFilter(e), class: {
            ...
            }, ghost: true, oval: true, icon: iconClear, size: "16", "aria-label": this.ariaLabelResetButton }));
    }
    getIconColor() {
        if (this.disabled) {
    ...
    render() {
        var _a, _b, _c;
        return (h(Host, { key: '159b06287f95ae0d34ffa4be4f6b347e236572be' }, h("form", { key: '33af16253af787446418717f4c3fbd8487dccc68', ref: (el) => (this.formElement = el) }, h("div", { key: 'f2a6119389dbba984c7fd446d1a9ef8c26a03521', "read-only": this.readonly, class: {
                'input-container': true,
                disabled: this.disabled,
                focus: this.hasFocus,
                readonly: this.readonly,
                'no-icon': this.hideIcon,
            } }, h("ix-icon", { key: 'c5ea70962ecafc8c5e64e935fcdc3be110c9f48e', color: this.getIconColor(), class: { 'display-none': this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, size: "16" }), h("div", { key: '7a804155cbb780c989dd7e56de656c70451d4aa3', class: "token-container" }, h("div", { key: 'bba13d7d6e4d497f77c7a399b1ef9eb674150942', class: "list-unstyled" }, this.filterTokens.map((value, index) => (h("span", { key: value.toString(), class: {
            ...
            } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label)), h("input", Object.assign({ key: '4f102ead6f9bcc711410eec5693a9da97e2bb2ba', class: {
                'text-input': true,
