...
import { F as FlipTileState } from './p-BQ6999e5.js';
import { y as iconEye } from './p-taILGXkr.js';
...
const FlipTile = /*@__PURE__*/ proxyCustomElement(class FlipTile extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return flipTileCss; }
        ...
        "width": [8],
        "index": [2],
        "ariaLabelEyeIconButton": [1, "aria-label-eye-icon-button"],
