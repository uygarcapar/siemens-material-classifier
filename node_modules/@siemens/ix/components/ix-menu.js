import { p as proxyCustomElement, H, e as createEvent, h, d as Host } from './p-TnTUyILo.js';
import { a as anime } from './p-Ou74PMQs.js';
import { s as showAppSwitch } from './p-DJQV9Cfq.js';
...
import { t as themeSwitcher } from './p-Hx4olgSM.js';
import { C as iconNavigationLeft, D as iconNavigationRight, i as iconApps, E as iconCogwheel, F as iconLightDark, o as iconInfo } from './p-taILGXkr.js';
import { d as defineCustomElement$7 } from './p-J_0lGtPw.js';
import { d as defineCustomElement$6 } from './p-COtZ6Z5L.js';
import { d as defineCustomElement$5 } from './p-CnZK1Nrc.js';
import { d as defineCustomElement$4 } from './p-DtMhlStk.js';
import { d as defineCustomElement$3 } from './p-cXDQwXWo.js';
import { d as defineCustomElement$2 } from './p-CbE4QYpW.js';
...
const Menu = /*@__PURE__*/ proxyCustomElement(class Menu extends H {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '0a82c9c443aee1e35eb9177193446311e324235b', class: {
                expanded: this.expand,
                [`breakpoint-${this.breakpoint}`]: true,
            }, slot: "menu" }, h("nav", { key: '591c2c777fa786e2ae5c747ddf748a1eb78e3ecb', class: {
                menu: true,
                expanded: this.expand,
            } }, h("div", { key: 'a5419a281f80e6fa2fcd6a77ea87b035c52919aa', class: "menu-buttons" }, this.breakpoint !== 'sm' && (h("ix-menu-expand-icon", { key: '26f50499ee3b98b0d4f3d20d798505a6274f78b7', breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" })), this.breakpoint === 'sm' &&
            ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && (h("ix-icon-button", { key: '69b93153a2ecabb8c0673490a466a30e52a2b5bb', onClick: () => {
                this.showAppSwitch();
            }, icon: iconApps, ghost: true }))), h("div", { key: '648d03ac32f70239abdd06fadeca9906afef9112', id: "menu-tabs", style: {
                display: 'contents',
            }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: 'f4472d51bf26d28bf83c7a381be6305fe748f001', class: "tabs-shadow-container" }, h("div", { key: '84585c74c3b5c6ba7d304298a22a19c79e1d3dde', class: {
                'tabs--shadow': true,
                'tabs--shadow-top': true,
                'tabs--shadow--show': this.itemsScrollShadowTop,
            } }), h("div", { key: '0e7777f3a7ca89b21a9c3b266e3ce4e7fb9ec129', class: {
                tabs: true,
                'show-scrollbar': this.expand,
            }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: '733c00670337417bd4ffe2e3eec2b8bdbef9f548', class: "menu-avatar" }, h("slot", { key: 'a484b0cc47a9ea9ce2ee617e506dec27633db8b8', name: "ix-menu-avatar" })), h("slot", { key: 'f31b045d1baf0bedbc334c9b6223a38c30a08b35', name: "home" }), this.breakpoint !== 'sm' || !this.isHiddenFromViewport() ? (h("slot", null)) : null), h("div", { key: '504778e5f20b8ff70e34f81b4e626ce3359e5b71', class: {
                'tabs--shadow': true,
                'tabs--shadow-bottom': true,
                'tabs--shadow--show': this.itemsScrollShadowBottom,
            } }))), h("div", { key: '5a3c4beceeca8824b6efced4cc7811d91fcc7b46', class: "bottom-tab-divider" }), this.settings ? (h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showSettings,
            }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings })) : null, this.enableToggleTheme ? (h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme })) : null, h("div", { key: '938b0cbcd3d7558837a18997ccd002fee30a03cf', onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: '5458d39911cf1e1ed247d8286900308274d92113', name: "bottom" })), h("div", { key: 'd1d3ea6c1272d4bddf01826cd26014f2eb51e738', id: "popover-area" }), this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? (h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() })) : null, this.about ? (h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showAbout,
            }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal })) : null), h("div", { key: 'd44b0a0729f071f009138f99060baf83f9ff1865', class: {
                'menu-overlay': true,
                ...
                this.checkTransition();
            } }, h("div", { key: 'b0e3037ff556f5bbd99a8fd335e666e1f1708847', class: 'menu-overlay-container' }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: 'e17fd327a492aa973209197b2c43b83c3e3674f1', class: 'menu-overlay-container' }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null))));
    }
...
function defineCustomElement$1() {
    ...
    const components = ["ix-menu", "ix-icon-button", "ix-menu-expand-icon", "ix-menu-item", "ix-spinner", "ix-tooltip", "ix-typography"];
