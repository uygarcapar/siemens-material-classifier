...
const TimeInput = /*@__PURE__*/ proxyCustomElement(class TimeInput extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    renderInput() {
        return (h("div", { class: "input-wrapper" }, h(SlotStart, { slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h("input", { autoComplete: "off", class: {
                ...
                this.ixBlur.emit();
                this.touched = true;
            } }), h(SlotEnd, { slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { "data-testid": "open-time-picker", class: { 'time-icon-hidden': this.disabled || this.readonly }, ghost: true, icon: iconClock, onClick: (event) => this.onTimeIconClick(event), "aria-label": "Toggle time picker", "aria-expanded": this.show }))));
    }
    ...
    render() {
        ...
        const invalidText = this.isInputInvalid
            ...
            : this.invalidText;
        return (h(Host, { key: '3db2c1bc5a23c47cf3c324513f3ba608d7f32d87', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, h("ix-field-wrapper", { key: 'ec5b4044f937b18c6307f22b8e4c04fa706a1bfa', label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText: invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: 'c9ddd23e8392b69bee921866003959c2b8890c05', "data-testid": "time-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
                this.show = event.detail;
            } }, h("ix-time-picker", { key: '171f6ab9ca2d7821a652878160ddee9a356e9477', ref: this.timePickerRef, format: this.format, time: (_a = this.time) !== null && _a !== void 0 ? _a : '', hourInterval: this.hourInterval, minuteInterval: this.minuteInterval, secondInterval: this.secondInterval, millisecondInterval: this.millisecondInterval, standaloneAppearance: false, i18nConfirmTime: this.i18nSelectTime, i18nHeader: this.i18nTime, i18nHourColumnHeader: this.i18nHourColumnHeader, i18nSecondColumnHeader: this.i18nSecondColumnHeader, i18nMinuteColumnHeader: this.i18nMinuteColumnHeader, i18nMillisecondColumnHeader: this.i18nMillisecondColumnHeader, onTimeSelect: (event) => {
    ...
    static get style() { return timeInputCss; }
        ...
        "i18nErrorTimeUnparsable": [1, "i18n-error-time-unparsable"],
        "hourInterval": [2, "hour-interval"],
        "minuteInterval": [2, "minute-interval"],
        "secondInterval": [2, "second-interval"],
        "millisecondInterval": [2, "millisecond-interval"],
        "i18nSelectTime": [1, "i18n-select-time"],
        "i18nTime": [1, "i18n-time"],
        "i18nHourColumnHeader": [1, "i18n-hour-column-header"],
...
function defineCustomElement$1() {
    ...
    const components = ["ix-time-input", "ix-button", "ix-date-time-card", "ix-dropdown", "ix-field-label", "ix-field-wrapper", "ix-icon-button", "ix-spinner", "ix-time-picker", "ix-tooltip", "ix-typography"];
...
const IxTimeInput = TimeInput;
const defineCustomElement = defineCustomElement$1;

export { IxTimeInput, defineCustomElement };
