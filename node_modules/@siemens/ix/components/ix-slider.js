...
import { O as OnListener } from './p-CP1_JI7K.js';
...
const Slider = /*@__PURE__*/ proxyCustomElement(class Slider extends H {
    ...
    render() {
        ...
        return (h(Host, { key: '6d4a31e9e38a5fe37516641ee75612124945c91b', class: {
            ...
            } }), h("div", { key: '050fdd0b142d02d926162051cbf84f4478700f1f', class: "ticks" }, this.marker
            ...
            : null)), h("input", Object.assign({ key: 'f17ebdb08b80303f10d356298e5458f277251a4a', id: "slider", type: "range", list: this.marker ? 'markers' : undefined, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), style: {
