...
const Blind = /*@__PURE__*/ proxyCustomElement(class Blind extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
