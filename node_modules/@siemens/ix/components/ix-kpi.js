...
import { p as iconWarning, B as iconAlarm } from './p-taILGXkr.js';
...
const Kpi = /*@__PURE__*/ proxyCustomElement(class Kpi extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return kpiCss; }
        ...
        "label": [1],
        "ariaLabelAlarmIcon": [1, "aria-label-alarm-icon"],
        "ariaLabelWarningIcon": [1, "aria-label-warning-icon"],
        "value": [8],
        "unit": [1],
        "state": [1],
        "orientation": [1]
