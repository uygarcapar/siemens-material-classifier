...
const ExpandingSearch = /*@__PURE__*/ proxyCustomElement(class ExpandingSearch extends H {
    expandInput() {
    ...
    render() {
        ...
        return (h(Host, { key: '1870937b249e7a49927e6d557c5b870371f6765e', class: {
                ...
                this.collapseInput();
                this.hasFocus = false;
            }, onFocus: () => (this.hasFocus = true), onInput: (e) => this.onChange(e), tabindex: this.expanded ? 0 : -1, "aria-label": this.ariaLabelSearchInput }), this.isFieldChanged ? (h("ix-icon-button", { class: "btn-clear", icon: iconClear, ghost: true, size: "16", "data-testid": "clear-button", onClick: () => this.clearClicked(), "aria-label": this.ariaLabelClearIconButton })) : null)));
    }
    static get style() { return expandingSearchCss; }
        ...
        "outline": [4],
        "ghost": [4],
        "ariaLabelSearchIconButton": [1, "aria-label-search-icon-button"],
        "ariaLabelClearIconButton": [1, "aria-label-clear-icon-button"],
        "ariaLabelSearchInput": [1, "aria-label-search-input"],
        "isFieldChanged": [32],
        "expanded": [32],
        "hasFocus": [32]
    }]);
