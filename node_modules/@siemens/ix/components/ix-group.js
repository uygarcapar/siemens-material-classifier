...
import { b as iconChevronDownSmall, w as iconChevronUpSmall } from './p-taILGXkr.js';
import { d as defineCustomElement$5 } from './p-BYikq6PJ.js';
import { d as defineCustomElement$4 } from './p-nR8RexI3.js';
import { d as defineCustomElement$3 } from './p-J_0lGtPw.js';
...
const Group = /*@__PURE__*/ proxyCustomElement(class Group extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h(Host, { key: 'd082d22d88ff20f978bf888c1954018ccb334340' }, h("div", { key: '95ad654ab3ba0ba95c03f58a12410716cbedcf69', class: {
                'group-header': true,
                expand: !this.collapsed,
                selected: this.selected,
            }, tabindex: "0" }, h("div", { key: '23ed93c470074df12a5d4d288c24d46fb4f8e540', class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, h("div", { key: '6038f9cce575f66b665b2590b53f45583dbec56c', class: {
                'group-header-selection-indicator': true,
                'group-header-selection-indicator-item-selected': this.itemSelected,
            } }), h("div", { key: '267dbac1dd05b836d2e02c7eadafcc9e85728bfb', class: "btn-expand-header" }, h("ix-icon", { key: 'adee543f2ffdfde656850bbaf72b0f7a9ade40b3', "data-testid": "expand-collapsed-icon", class: {
                hidden: !this.showExpandCollapsedIcon,
            }, name: this.collapsed ? iconChevronDownSmall : iconChevronUpSmall, onClick: (event) => this.onExpandClick(event) })), h("div", { key: 'd61c48ca2278eefabfb29a4a7f95ba8679bddea8', class: "group-header-content" }, this.header ? (h("div", { class: "group-header-props-container" }, h("div", { class: "group-header-title" }, h("span", { title: this.header }, this.header)), h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader))) : null, h("slot", { key: 'f9ef67f6d5d5502c01eb3c951f24f00f9ea4f430', name: "header" }))), this.hasDropdown && (h("ix-group-context-menu", { key: '9b72c63b4a96b7ad856c5c76de9a8aa2ac7edd60' }, h("slot", { key: '0ab6d7702e840833c92dad199fc938af5ca768bd', name: "dropdown" })))), h("div", { key: 'fe98c2dbc88d0d4845e29567e34cb8bed64c7f08', class: {
                'group-content': true,
            } }, h("div", { key: '52f5543335083fea7692df593cbb61e0e7dde85e', style: {
                display: this.collapsed ? 'none' : 'contents',
            } }, h("slot", { key: '87a93624ea3663137d2960b35f2f3649c3d6d2a0', onSlotchange: () => {
                var _a;
            ...
            } }), h("ix-group-item", { key: 'f32edf031e8e6b6edf2748cb2b805e8440bba231', suppressSelection: true, focusable: false, class: {
                footer: true,
                'footer-visible': this.footerVisible,
            } }, h("slot", { key: '9b7510bedc970fe093496f055c97c32c715bcba8', name: "footer", onSlotchange: () => this.onSlotChange() }))))));
    }
