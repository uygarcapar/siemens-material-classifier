...
import { g as getButtonClasses } from './p-BsUt3nQm.js';
import { a as a11yBoolean } from './p-Bb7pDeaQ.js';
import { t as iconDoubleChevronLeft, u as iconDoubleChevronRight } from './p-taILGXkr.js';
import { d as defineCustomElement$2 } from './p-J_0lGtPw.js';
import { d as defineCustomElement$1 } from './p-DtMhlStk.js';
...
const MenuExpandIcon = /*@__PURE__*/ proxyCustomElement(class MenuExpandIcon extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    getSmallScreenIcon() {
        return (h("button", { class: Object.assign(Object.assign({}, getButtonClasses('secondary', false, true, true, false, false, false)), { 'menu-expand-button': true }) }, h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24", height: "24" }, h("rect", { class: "line line-1", x: "2", y: "5", width: "20", height: "2" }), h("rect", { class: "line line-2", x: "2", y: "11", width: "13", height: "2" }), h("rect", { class: "line line-3", x: "2", y: "17", width: "20", height: "2" }))));
    }
    getLargeScreenIcon() {
        return (h("ix-icon-button", { icon: this.expanded ? iconDoubleChevronLeft : iconDoubleChevronRight, ghost: true }));
    }
    getMenuIcon() {
        if (this.pinned) {
    ...
    render() {
        return (h(Host, { key: 'ea63ca6b29ac5da5c70d8aafbee54a4082e0b4f6', class: {
...
function defineCustomElement() {
    ...
    const components = ["ix-menu-expand-icon", "ix-icon-button", "ix-spinner"];
    components.forEach(tagName => { switch (tagName) {
        case "ix-menu-expand-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MenuExpandIcon);
            }
            break;
        case "ix-icon-button":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=p-COtZ6Z5L.js.map
