...
import { G as iconDocument } from './p-taILGXkr.js';
import { d as defineCustomElement$2 } from './p-cXDQwXWo.js';
...
const MenuItem = /*@__PURE__*/ proxyCustomElement(class MenuItem extends H {
    ...
    render() {
        ...
        return (h(Host, Object.assign({ key: '3c97be99972609f07b9ebd733c84237e90a2061e', class: {
            ...
            !this.isHostedInsideCategory &&
            !this.menuExpanded && (h("ix-tooltip", { key: 'e9e5e232cb0e49f1e1e752a8a2baae31179cc86c', for: this.buttonRef.waitForCurrent(), placement: 'right', showDelay: 1000 }, this.tooltip))));
    }
...
function defineCustomElement() {
    ...
    const components = ["ix-menu-item", "ix-tooltip", "ix-typography"];
...
//# sourceMappingURL=p-CnZK1Nrc.js.map
