...
import { d as defineCustomElement$3 } from './p-DFvTgVvo.js';
...
const Upload = /*@__PURE__*/ proxyCustomElement(class Upload extends H {
    get inputElement() {
    ...
    render() {
        ...
        return (h(Host, Object.assign({ key: '290d7288ba9353fbcb6a1932e0c9d579fc6b971b' }, a11y, { "aria-disabled": disabled }), h("div", { key: 'e31775cbc624c50f7a57572491d9c0ad15f5eceb', class: {
            ...
            }, accept: this.accept, disabled: disabled }), h("ix-button", { key: 'f533ee7f7ecad63d2737bfa69e16db13884ed015', "aria-disabled": disabled, outline: true, onClick: () => this.inputElement.click(), disabled: disabled }, this.i18nUploadFile)))));
    }
