...
const IconToggleButton = /*@__PURE__*/ proxyCustomElement(class IconToggleButton extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        ...
        return (h(Host, { key: 'c7470cadb255d49fce17de6be7272507a2662f47', class: Object.assign(Object.assign({}, this.getIconSizeClass()), { disabled: this.disabled || this.loading }) }, h(BaseIconButton, Object.assign({ key: 'e5f3f66e6e9e9efbc8ef3400a774e6f47cea4499' }, baseButtonProps))));
    }
    ...
    static get style() { return iconToggleButtonCss; }
        ...
        "disabled": [516],
        "loading": [4],
        "ariaLabelIconButton": [1, "aria-label-icon-button"]
    }]);
