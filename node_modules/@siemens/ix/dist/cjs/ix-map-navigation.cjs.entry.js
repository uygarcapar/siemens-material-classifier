...
const MapNavigation = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1a223c8842dd37faa6b78c82fa713e3b0b3a852e' }, index.h("slot", { key: 'e72b19ae900c98977fd19b53fb3c0b88e8aecf4e', name: "menu" }), index.h("div", { key: '934855ed86770b78764f878897a11d79073ac765', class: "map-nav" }, index.h("div", { key: '64034047cedf23818ab09755570cc16c97f555cb', class: "map-nav-sidebar" }, index.h("div", { key: '450e88db9c1bc6dd73015ea0cd77f3db899c0248', class: "map-nav-header" }, index.h("ix-application-header", { key: '43059244fb12002771d6c064cb6a72452dd513c1', name: this.applicationName, class: "map-nav-header-brand" }, index.h("slot", { key: 'f559f98b7cde095532830efb30f5ee979d0e1b93', slot: "logo", name: "logo" }))), index.h("div", { key: '15a27e5b20fd7127d895cfc885a490e09a4a298a', class: "map-nav-sidebar-content" }, index.h("div", { key: '90628e604ca9a6ebdc750f417c3d3e0dd25905be', class: "map-nav-sidebar-static-content" }, index.h("div", { key: '51c9d486c284709ae46347cbb8f13519503ce6fd', class: "map-nav-title" }, this.navigationTitle), this.hideContextMenu ? ('') : (index.h("ix-icon-button", { icon: index$1.iconContextMenu, ghost: true, size: "24", variant: "secondary", onClick: (_) => this.contextMenuClick.emit(), "aria-label": this.ariaLabelContextIconButton }))), index.h("div", { key: '04a9e0e79eb47dfb728bbc06478d6cddd88509bd', class: "map-nav-sidebar-user-content" }, index.h("slot", { key: 'cc5e1aeb818330cbae337369170f4ae2ea60ae6d', name: "sidebar-content" })))), index.h("div", { key: '2361b5a10b8fe716a41b2dd2e7f6b8cc416e8cfb', class: "content" }, index.h("div", { key: 'b6d874d45af94ee319061f0eb7a8f1b2f80aa187', class: {
                'map-nav-header-content': true,
                'bg-2': true,
                empty: !this.hasContentHeader,
            } }, index.h("slot", { key: 'cee282312d76f8825bd4790a966e84061ae61c48', name: "content-header", onSlotchange: (e) => this.checkHasContentHeader(e) })), index.h("main", { key: 'a0743c77f4ef72adb880e97af85f00bba335aa55' }, index.h("slot", { key: '1a5f49709e7d82c3ff8a6cabc6f7a7c9868a0e30' }), index.h("slot", { key: 'd0774a8ed2961f0d79fdbbaec27b85978fa99cf8', name: "overlay" }))))));
    }
...
//# sourceMappingURL=ix-map-navigation.entry.cjs.js.map
