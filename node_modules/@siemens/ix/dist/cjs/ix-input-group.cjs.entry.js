...
const InputGroup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '24b0c17b0f760e00b0c04d976e1ca73e3f7add6a', class: { disabled: this.disabled } }, index.h("div", { key: 'd18998af36460aa37b025e4c53fbaa4f70c82533', class: "group group-start" }, index.h("slot", { key: '70d66198ddf8ba6d9e4676ed6055e370b956aecf', ref: (el) => (this.startSlotRef = el), name: "input-start" })), index.h("slot", { key: 'dfceaca91998ff431ebfc42113971c8b28f25c2a' }), index.h("div", { key: '910403e5b7e4370fb7f810253e4d304a0fa65f45', class: "group group-end" }, index.h("slot", { key: '1d1916855ed606041c9865a9f52a65b11ee076bc', ref: (el) => (this.endSlotRef = el), name: "input-end" }))));
    }
...
//# sourceMappingURL=ix-input-group.entry.cjs.js.map
