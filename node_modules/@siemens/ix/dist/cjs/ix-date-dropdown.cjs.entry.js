...
const DateDropdown = class {
    constructor(hostRef) {
        ...
        this.triggerRef = makeRef.makeRef();
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: 'ce1ccdbcb37e440f1180a6fb9a70d967dd37a874' }, index.h("ix-button", { key: 'e3c9c8a499004281bb0b63c8e58b8657cf75dd04', "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, ghost: this.ghost, outline: this.outline, loading: this.loading, icon: index$1.iconHistory, ref: this.triggerRef, disabled: this.disabled, ariaLabel: this.ariaLabelDropdownButton }, this.getButtonLabel()), index.h("ix-dropdown", { key: '4c2dd95942ffcc4289ea37d718afb7f231edf4a8', "data-testid": "date-dropdown", "data-date-dropdown": true, class: "min-width max-height", trigger: this.triggerRef.waitForCurrent(), closeBehavior: "outside", placement: "bottom-start", onShowChanged: ({ detail: show }) => {
                if (!show &&
                    this.selectedDateRangeId === 'custom' &&
            ...
            } }, index.h("ix-layout-grid", { key: '7aaae433395f0ecee34ace5f0315ebd5ecd0a462', noMargin: true }, index.h("ix-row", { key: '2bf03cb45a37915d959a9ee2ecdd6e4435138eed' }, ((_a = this.dateRangeOptions) === null || _a === void 0 ? void 0 : _a.length) > 1 && (index.h("ix-col", { key: 'b4e94223ff4d6ed6942f57f3f4ff2a81f4c9e1d3', class: {
                'no-margin': true,
                'border-right': this.selectedDateRangeId === 'custom',
            } }, this.dateRangeOptions.map((dateRangeOption) => (index.h("ix-dropdown-item", { label: dateRangeOption.label, onClick: () => this.onRangeListSelect(dateRangeOption.id), checked: this.selectedDateRangeId === dateRangeOption.id }))), index.h("div", { key: '75c58e0f961dd531c09fd05d6a2ce96894752379', hidden: !this.customRangeAllowed }, index.h("ix-dropdown-item", { key: '35efaababa6f19a9bb8987f8e60bb5b2730a4ff2', label: this.i18nCustomItem, checked: this.selectedDateRangeId === 'custom', onClick: () => this.onRangeListSelect('custom') })))), index.h("ix-col", { key: '9cde18f824b5d2c553f3a03ec3277c84012a985e', class: "no-margin" }, this.selectedDateRangeId === 'custom' && (index.h(index.Fragment, { key: '0e86d2f2fa8f750877e72a0882cf6619079c6f99' }, index.h("ix-date-picker", { key: '54c23f5b71945e683b46b91ae66833a4af46fd57', standaloneAppearance: false, locale: this.locale, onDateChange: (e) => {
                e.stopPropagation();
                this.currentRangeValue = Object.assign(Object.assign({}, e.detail), { id: 'custom' });
                this.datePickerTouched = true;
            }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, range: this.range, from: this.from || ((_b = this.currentRangeValue) === null || _b === void 0 ? void 0 : _b.from), to: this.to || ((_c = this.currentRangeValue) === null || _c === void 0 ? void 0 : _c.to), minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), index.h("div", { key: '0ddcbffe973079c6a70ada4c08e3eb7b2362cffa', class: "pull-right" }, index.h("ix-button", { key: 'a8ea23efcf1423ac342077d1090b5c5b51760fcb', onClick: () => {
                if (this.currentRangeValue) {
                    this.onDateSelect(this.currentRangeValue);
                }
            } }, this.i18nDone))))))))));
...
//# sourceMappingURL=ix-date-dropdown.entry.cjs.js.map
