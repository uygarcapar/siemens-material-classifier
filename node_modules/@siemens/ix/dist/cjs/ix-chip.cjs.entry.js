...
const Chip = class {
    constructor(hostRef) {
        ...
        this.containerElementRef = makeRef.makeRef();
    }
    getCloseButton() {
        return (index.h("div", { class: "close-button-container" }, index.h("ix-icon-button", { type: "button", variant: "secondary", icon: index$1.iconCloseSmall, class: "close-button", oval: true, size: "16", style: this.variant === 'custom' ? { color: this.chipColor } : {}, ghost: true, onClick: (event) => {
    ...
    getTooltip() {
        ...
        return (index.h("ix-tooltip", { for: this.containerElementRef.waitForCurrent() }, text));
    }
    render() {
        ...
        return (index.h(index.Host, { key: '90d999b25775c9ec6f5cd98417ce98e44e60d4d7', tabIndex: "-1", class: {
                inactive: isInactive,
            }, style: this.variant === 'custom'
                ? {
                    '--ix-icon-button-color': this.chipColor,
                }
                : {} }, index.h("div", { key: '54d203688f0f91f9fef8d21b49ec95baf7465634', ref: this.containerElementRef, style: Object.assign({}, customStyle), class: {
                container: true,
            ...
            } }, index.h("div", { key: 'd6195dbed734305bb281a2395b0b47d2951a2144', class: "content-wrapper" }, this.icon && (index.h("ix-icon", { key: '7da1b50039d3282f89a010ce32fc71a69c9f99fb', class: {
                'with-icon': true,
            }, name: this.icon, size: '24', style: this.variant === 'custom'
                ? { color: this.outline ? this.background : this.chipColor }
                : undefined })), index.h("span", { key: '4ce076c7b4842bfda0001d7a8e93952c64d13c47', class: "slot-container" }, index.h("slot", { key: '8713a2201e364feb0744124fe71a58ec92737b34' }))), isInactive === false && this.closable ? this.getCloseButton() : null), this.getTooltip()));
    }
...
//# sourceMappingURL=ix-chip.entry.cjs.js.map
