...
var input_util = require('./input.util-CJeJb7AB.js');
var validation = require('./validation-Dugh-A-f.js');
...
const TimeInput = class {
    constructor(hostRef) {
        ...
        this.valueChange = index.createEvent(this, "valueChange", 6);
        this.validityStateChange = index.createEvent(this, "validityStateChange", 7);
        this.ixFocus = index.createEvent(this, "ixFocus", 7);
        this.ixBlur = index.createEvent(this, "ixBlur", 7);
        ...
        this.slotEndRef = makeRef.makeRef();
        this.timePickerRef = makeRef.makeRef();
        this.inputElementRef = makeRef.makeRef();
        this.dropdownElementRef = makeRef.makeRef();
        this.touched = false;
    }
    ...
    connectedCallback() {
        ...
        this.disposableChangesAndVisibilityObservers =
            input_util.addDisposableChangesAndVisibilityObservers(this.hostElement, this.updatePaddings.bind(this));
    }
    componentWillLoad() {
        if (!this.value) {
    ...
    updatePaddings() {
        input_util.adjustPaddingForStartAndEnd(this.slotStartRef.current, this.slotEndRef.current, this.inputElementRef.current);
    }
    ...
    async onInput(value) {
        ...
        const time = datetime.DateTime.fromFormat(value, this.format);
        if (time.isValid) {
            this.isInputInvalid = false;
        }
        else {
    ...
    renderInput() {
        return (index.h("div", { class: "input-wrapper" }, index.h(input_util.SlotStart, { slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), index.h("input", { autoComplete: "off", class: {
                ...
                this.ixBlur.emit();
                this.touched = true;
            } }), index.h(input_util.SlotEnd, { slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, index.h("ix-icon-button", { "data-testid": "open-time-picker", class: { 'time-icon-hidden': this.disabled || this.readonly }, ghost: true, icon: index$1.iconClock, onClick: (event) => this.onTimeIconClick(event), "aria-label": "Toggle time picker", "aria-expanded": this.show }))));
    }
    ...
    render() {
        ...
        const invalidText = this.isInputInvalid
            ...
            : this.invalidText;
        return (index.h(index.Host, { key: '3db2c1bc5a23c47cf3c324513f3ba608d7f32d87', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: 'ec5b4044f937b18c6307f22b8e4c04fa706a1bfa', label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText: invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), index.h("ix-dropdown", { key: 'c9ddd23e8392b69bee921866003959c2b8890c05', "data-testid": "time-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
                this.show = event.detail;
            } }, index.h("ix-time-picker", { key: '171f6ab9ca2d7821a652878160ddee9a356e9477', ref: this.timePickerRef, format: this.format, time: (_a = this.time) !== null && _a !== void 0 ? _a : '', hourInterval: this.hourInterval, minuteInterval: this.minuteInterval, secondInterval: this.secondInterval, millisecondInterval: this.millisecondInterval, standaloneAppearance: false, i18nConfirmTime: this.i18nSelectTime, i18nHeader: this.i18nTime, i18nHourColumnHeader: this.i18nHourColumnHeader, i18nSecondColumnHeader: this.i18nSecondColumnHeader, i18nMinuteColumnHeader: this.i18nMinuteColumnHeader, i18nMillisecondColumnHeader: this.i18nMillisecondColumnHeader, onTimeSelect: (event) => {
...
exports.ix_time_input = TimeInput;
//# sourceMappingURL=ix-time-input.entry.cjs.js.map

//# sourceMappingURL=ix-time-input.cjs.entry.js.map