...
function LinearBar({ value, }) {
    return (index.h("div", { class: "linear-progress-container" },
        index.h("div", { class: "progress", role: "progressbar", "aria-valuenow": value, "aria-valuemin": 0, "aria-valuemax": 100 },
            index.h("div", { class: {
                    'progress-bar': true,
...
const CircularProgress = (props, children) => {
    ...
    return (index.h("div", { class: {
        ...
        index.h("svg", { width: sizeInPixel, height: sizeInPixel, viewBox: `-${sizeInPixel * 0.125} -${sizeInPixel * 0.125} ${sizeInPixel * 1.25} ${sizeInPixel * 1.25}`, version: "1.1", xmlns: "http://www.w3.org/2000/svg", style: { transform: 'rotate(-90deg)' } },
            index.h("circle", { r: radius, cx: radius, cy: radius, fill: "transparent", stroke: "var(--theme-color-component-4)", "stroke-width": `3px` }),
            percentage > 0 && (index.h("circle", { r: radius, cx: radius, cy: radius, stroke: "var(--ix-progress-indicator-color)", "stroke-width": "3px", "stroke-dashoffset": `${percentage}px`, fill: "transparent", "stroke-dasharray": `${circumference}px` })),
            index.h("foreignObject", { x: `0px`, y: `0px`, width: `${sizeInPixel}px`, height: `${sizeInPixel}px`, style: {
                    transform: `rotate(90deg) translate(0px, -${sizeInPixel}px)`,
                } }, slotInsideCircular && (index.h("div", { class: "slotted-container slotted-container-inside" }, children)))),
        !slotInsideCircular && index.h("div", { class: "slotted-container" }, children)));
};
...
const ProgressIndicator = class {
    ...
    getHelperText() {
        ...
        switch (this.status) {
            case 'error':
                icon = index$1.iconError;
                break;
            case 'info':
                icon = index$1.iconInfo;
                break;
            case 'warning':
                icon = index$1.iconWarning;
                break;
            case 'success':
                icon = index$1.iconSuccess;
                break;
            case 'paused':
                icon = index$1.iconCirclePause;
                break;
            default:
                icon = null;
        }
        if (!this.helperText) {
            return index.h("slot", { name: "helper-text" });
        }
        return (index.h("div", { class: {
                'helper-text': true,
                [this.status]: true,
            } }, icon && index.h("ix-icon", { name: icon, size: "16" }), index.h("div", { class: {
                text: true,
                'align-left': this.textAlignment === 'left',
                'align-center': this.textAlignment === 'center',
                'align-right': this.textAlignment === 'right',
            } }, this.helperText), index.h("slot", { name: "helper-text" })));
    }
    render() {
        ...
        return (index.h(index.Host, { key: '631e87bd03afc9f408d0784fc9c00d0cc26a13b0', class: {
                linear: this.type === 'linear',
                circular: this.type === 'circular',
            }, tabIndex: -1 }, index.h("div", { key: 'd21e6a6c03bf6c7fb228fe8f3bc81c555ee1f401', class: {
            ...
            } }, this.label && (index.h("ix-typography", { key: '8b1a531de706ce65e978bf2f72d39f8c7e674a46', format: "label", textColor: this.status === 'error' ? 'alarm' : 'soft', class: 'label' }, this.label)), index.h("div", { key: '678750aea2a5cbe004985ffff9b4034ed3aedb12', class: "progress-container" }, this.type === 'linear' ? (index.h(index.Fragment, null, index.h(LinearBar, { value: clampedValue }), index.h("div", { class: "linear-slot" }, index.h("slot", null)))) : (index.h(CircularProgress, { alignment: this.textAlignment, value: clampedValue, size: this.size }, index.h("slot", null)))), this.showTextAsTooltip === true && this.helperText ? (index.h("ix-tooltip", { for: this.hostElement, showDelay: 500, placement: "bottom" }, this.getHelperText())) : (this.getHelperText()))));
    }
    get hostElement() { return index.getElement(this); }
};
ProgressIndicator.style = progressIndicatorCss;

exports.ix_progress_indicator = ProgressIndicator;
//# sourceMappingURL=ix-progress-indicator.entry.cjs.js.map

//# sourceMappingURL=ix-progress-indicator.cjs.entry.js.map