...
const EventListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '45315c323b72663ab459c1ac82be84a289719b6d', class: {
                disabled: this.disabled,
            } }, index.h("div", { key: '5d380bf2e02591a9be10a4e2b8b3585c83d035b5', role: "listitem", "aria-disabled": a11y.a11yBoolean(this.disabled), class: {
                'event-list-item': true,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("div", { key: '802085e76fa0a9c9d486f6f5777058da1d7ba9fd', class: `indicator ${!this.itemColor ? 'indicator-empty' : ''}`, style: {
                'background-color': this.itemColor ? color : 'inherit',
                opacity: `${this.disabled ? 0.4 : 1}`,
            } }), index.h("div", { key: 'e90e4d2f639ec22b161e2c57d361f959e20f60a9', class: "event-list-item-container" }, index.h("div", { key: '34a3a544f2f05078b9a75fbe80d1165a4bd10bde', class: "event-content" }, index.h("slot", { key: '4ef3f92e68fa17c1369ccdd6b60d27cdafd84596' })), this.chevron && (index.h("ix-icon", { key: '077fa6194e887ecf3b5e1e236534b4d49dc01c36', name: index$1.iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))))));
    }
};
EventListItem.style = eventListItemCss;

exports.ix_event_list_item = EventListItem;
//# sourceMappingURL=ix-event-list-item.entry.cjs.js.map
