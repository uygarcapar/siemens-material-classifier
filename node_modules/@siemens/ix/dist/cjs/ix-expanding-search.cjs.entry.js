...
const ExpandingSearch = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '1870937b249e7a49927e6d557c5b870371f6765e', class: {
                expanded: this.expanded,
                'right-position': this.expanded,
                fullWidth: this.fullWidth,
            } }, index.h("ix-icon-button", { key: '8bffb5b3ab92a7dd13ae6c1b89872fa749ff4a5c', size: this.expanded ? '16' : '24', icon: (_a = this.icon) !== null && _a !== void 0 ? _a : index$1.iconSearch, variant: this.expanded ? 'primary' : this.variant, ghost: this.ghost || this.expanded, outline: this.outline && !this.expanded, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? 'input-search-icon--color--focus' : undefined, class: {
                'btn-search': true,
                'btn-search--expanded': this.expanded,
            }, "aria-label": this.ariaLabelSearchIconButton }), index.h("div", { key: 'e6192ba638e07157970eb88f13cf1d0eab014675', class: {
                expanded: this.expanded,
                fullWidth: this.fullWidth,
                collapsed: !this.expanded,
                'disable-pointer': !this.expanded,
                'input-container': true,
            }, "data-testid": "input-wrapper" }, index.h("input", { key: '45dc5684148709adc95530573b8b9f508b09165b', class: {
                ...
                this.collapseInput();
                this.hasFocus = false;
            }, onFocus: () => (this.hasFocus = true), onInput: (e) => this.onChange(e), tabindex: this.expanded ? 0 : -1, "aria-label": this.ariaLabelSearchInput }), this.isFieldChanged ? (index.h("ix-icon-button", { class: "btn-clear", icon: index$1.iconClear, ghost: true, size: "16", "data-testid": "clear-button", onClick: () => this.clearClicked(), "aria-label": this.ariaLabelClearIconButton })) : null)));
    }
};
ExpandingSearch.style = expandingSearchCss;

exports.ix_expanding_search = ExpandingSearch;
//# sourceMappingURL=ix-expanding-search.entry.cjs.js.map
