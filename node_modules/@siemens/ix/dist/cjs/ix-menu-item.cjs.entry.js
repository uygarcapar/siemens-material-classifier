...
const MenuItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, Object.assign({ key: '3c97be99972609f07b9ebd733c84237e90a2061e', class: {
                disabled: this.disabled,
                'home-tab': this.home,
                'bottom-tab': this.bottom,
                active: this.active,
                'tab-nested': this.isHostedInsideCategory,
            } }, extendedAttributes), index.h("button", { key: '0a8a4ded3ca8f4fdfd8a875a62d2437d30098057', class: "tab", tabIndex: this.disabled ? -1 : 0, ref: this.buttonRef }, this.icon && index.h("ix-icon", { key: '61ffdd54c8123942e05eea275a40e6dc099a0bba', class: 'tab-icon', name: this.icon }), this.notifications ? (index.h("div", { class: "notification" }, index.h("div", { class: "pill" }, this.notifications))) : null, index.h("span", { key: '54a456cb810b2c8c393b5b81ebee9334c58ce1db', class: "tab-text text-default" }, this.label, index.h("slot", { key: 'a4c0d80d3778add2f069dbc0c0597b257b468ec8' }))), !this.isCategory &&
            !this.isHostedInsideCategory &&
            !this.menuExpanded && (index.h("ix-tooltip", { key: 'e9e5e232cb0e49f1e1e752a8a2baae31179cc86c', for: this.buttonRef.waitForCurrent(), placement: 'right', showDelay: 1000 }, this.tooltip))));
    }
