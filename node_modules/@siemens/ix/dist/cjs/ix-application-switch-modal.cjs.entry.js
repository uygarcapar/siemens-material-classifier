...
var modal = require('./modal-Copb6voF.js');
...
function ApplicationItem(props) {
    ...
    return (index.h("button", { class: {
        ...
        } }, index.h("div", null, index.h("img", { class: "AppIcon", src: props.iconSrc })), index.h("div", { class: "AppName" }, index.h("ix-typography", { format: "h4" }, props.name, isExternal(props.target) && (index.h("ix-icon", { size: "12", name: index$1.iconOpenExternal, color: "color-soft-text" }))), index.h("ix-typography", { format: "label-sm", textColor: "soft" }, props.description))));
}
const ApplicationSwitchModal = class {
    ...
    render() {
        var _a, _b, _c, _d;
        return (index.h(index.Host, { key: 'a4279dbad5812faf0833dccc9b872b4618d3b721' }, index.h("ix-modal-header", { key: '2aeba11eb0d8e2f927a1a454d462aa1d2be8f797', icon: index$1.iconApps }, ((_a = this.config) === null || _a === void 0 ? void 0 : _a.i18nAppSwitch) || 'Switch to application'), index.h("ix-modal-content", { key: 'e9b3da826aad0519a8ce43879f6ac609370c3e0b', class: "content" }, index.h("div", { key: '89696259fb23ca82f9be6614afa44aa0d4e0955a', class: "content-apps" }, (!this.config || ((_b = this.config) === null || _b === void 0 ? void 0 : _b.apps.length) === 0) && (index.h("div", { key: '411aaac0b82835301e909b751ee640054b1c7722', class: "loading" }, index.h("ix-spinner", { key: '3f1580e44ee6306acee76547fe375094a334e421', size: "medium", variant: "primary" }), index.h("span", { key: '434d97bd9e210b534a3461bf7c5578e13fd4fb3e' }, ((_c = this.config) === null || _c === void 0 ? void 0 : _c.i18nLoadingApps) ||
...
//# sourceMappingURL=ix-application-switch-modal.entry.cjs.js.map
