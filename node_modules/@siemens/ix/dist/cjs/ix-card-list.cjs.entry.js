...
function CardListTitle(props) {
    ...
    return (index.h("div", { class: "CardList_Title" }, index.h("ix-icon-button", { ghost: true, icon: index$1.iconChevronDown, onClick: props.onClick, iconColor: "color-primary", class: {
            CardList__Title__Button: true,
            CardList__Title__Button__Collapsed: props.isCollapsed,
        }, "aria-label": props.ariaLabelExpandButton }), index.h("ix-typography", { class: "CardList_Title__Label", format: "body-lg" }, props.label), !props.hideShowAll && (index.h("ix-button", { class: "CardList__Title__Show__All", ghost: true, onClick: props.onShowAllClick }, index.h("span", null, props.showAllLabel), index.h("span", null, !isNaN(props.showAllCounter) ? ` (${props.showAllCounter})` : null)))));
}
const CardList = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd0b2d3841147f1c3da12c2e5a41f2a4a5e4343d1' }, index.h(CardListTitle, { key: '559cddd2fc59b370a8a2bb642972771cc96dcec9', isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === undefined
                ? this.numberOfAllChildElements
                : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), index.h("div", { key: '40dd1b41b6b4a731d643de4ab5f45830e6ae0fc4', class: {
                CardList__Overflow: true,
            }, style: this.computeMaskLayer() }, index.h("div", { key: '2753bc34b6e3e73288a38c925d79e8068b90316f', class: {
            ...
            }, onScroll: () => this.onCardListScroll() }, index.h("slot", { key: 'fd72c18c005fbf0260f2075979c0cd7be7d3864d', onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? (index.h("ix-card", { class: {
                Show__All__Card: true,
            }, onClick: (event) => this.showMoreCardClick.emit({
                nativeEvent: event,
            }) }, index.h("ix-card-content", null, index.h("div", { class: "Show__All__Card__Content" }, index.h("ix-icon", { name: index$1.iconMoreMenu, size: '32', class: 'Show__All__Card__Icon' }), index.h("span", { class: "Show__All__Card__Text" }, this.i18nMoreCards, " (", this.numberOfOverflowingElements, ")"))))) : null))));
    }
...
//# sourceMappingURL=ix-card-list.entry.cjs.js.map
