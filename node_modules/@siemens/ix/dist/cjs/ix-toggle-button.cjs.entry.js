...
const ToggleButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '13d36b641b996256c5629c113b91717b56f4e1d2', class: {
                disabled: this.disabled || this.loading,
            } }, index.h(baseButton.BaseButton, Object.assign({ key: 'c15bd2ee728b333e414e0f6d134b9ee657bb90d5' }, baseButtonProps), index.h("slot", { key: '232b3ee11179adbd9639dded560df0f36893abfe' }))));
    }
};
ToggleButton.style = toggleButtonCss;

exports.ix_toggle_button = ToggleButton;
//# sourceMappingURL=ix-toggle-button.entry.cjs.js.map
