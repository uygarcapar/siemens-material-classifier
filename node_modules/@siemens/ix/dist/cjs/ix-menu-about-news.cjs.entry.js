...
const MenuAboutNews = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c64b5cf97a522d325d022d8c926d8c9734646425', class: {
                expanded: this.expanded,
                show: !this.show,
            } }, index.h("div", { key: '9ba716f9fcc223d7b5b2d9bc28c2f8f28a457462', class: "banner-container" }, index.h("ix-icon", { key: '798f58b181ab9e91f8b1d88567eec52f6442978b', color: "color-inv-contrast-text", name: index$1.iconShout, size: "32" }), index.h("svg", { key: '46bad2b7a6bf5ceb43c305b9e5089a2bbdb18c22', viewBox: "0 0 48 56", xmlns: "http://www.w3.org/2000/svg" }, index.h("polygon", { key: '6a4b421a8d3dbabf524dec74b37476f968646fb8', points: "0 0 48 0 48 56 24 48 0 56" }))), index.h("div", { key: 'f2180d9fcee77160fc4b1ad071e57ed3adf160a3', class: "cui-popover-news-header" }, index.h("ix-typography", { key: '8831582147f84df598c0b138f6f438259b161cc3', format: "label", bold: true }, this.label)), index.h("ix-icon-button", { key: '13a882de3bb1422ff65eac1d8b53740b3fb552e5', size: "24", icon: index$1.iconClose, ghost: true, onClick: () => {
                this.show = false;
                this.closePopover.emit();
            } }), index.h("div", { key: 'e60241c90b56bae060f50035daa12d165d6be785', class: "slot-container" }, index.h("slot", { key: '8a0e881cfa403d2576e4cfbb149f310316d53fba' })), this.aboutItemLabel ? (index.h("div", { class: "cui-popover-news-footer" }, index.h("ix-button", { variant: "primary", onClick: (e) => {
                this.show = false;
                this.showMore.emit(e);
            } }, this.i18nShowMore))) : null, index.h("div", { key: 'a4516f11dc0ccc3e492f8fca096d03938a415439', id: "arrow" })));
    }
};
MenuAboutNews.style = menuAboutNewsCss;

exports.ix_menu_about_news = MenuAboutNews;
//# sourceMappingURL=ix-menu-about-news.entry.cjs.js.map
