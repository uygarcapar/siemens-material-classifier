...
const MapNavigationOverlay = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: 'bb277fc0e934180c8b899afcbd2a8a0eb2eb3e35' }, index.h("div", { key: '90c1d76903009f37c1cb906aad1a811b6c677e6f', class: "overlay-header" }, index.h("div", { key: 'f1c42425565386e95f0a7f242d809e6bf4edfa07', class: {
                ...
                'background-color': ((_b = this.iconColor) !== null && _b !== void 0 ? _b : this.color)
                    ...
                    : '',
            } }), index.h("div", { key: 'cd18a1108f2aa7bccef90e2e10c4aaec08160a30', class: "overlay-header-content" }, index.h("ix-icon", { key: 'ad9a3e1e66caa8e04f09fb78a62c29e73ba20aea', size: "32", name: this.icon, "aria-label": this.ariaLabelIcon }), index.h("span", { key: '1d18d66f01d3e71338b0e2718c3abb61ea92c3f6', class: "overlay-header-title", title: this.name }, this.name)), index.h("ix-icon-button", { key: 'c38d99d73cedf2f289bf06f8b13637265ffe19ec', class: "overlay-close", ghost: true, icon: index$1.iconClose, size: "24", onClick: () => this.closeOverlay(), "aria-label": this.ariaLabelCloseIconButton })), index.h("slot", { key: '5dbcc54a1d12905063b562c5276e8569cd7c5263' })));
    }
...
//# sourceMappingURL=ix-map-navigation-overlay.entry.cjs.js.map
