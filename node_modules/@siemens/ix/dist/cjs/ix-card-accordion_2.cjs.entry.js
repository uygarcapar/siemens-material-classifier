...
const CardAccordion = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3e3960522e656a178f2c3e57778c999d9a04fba8', slot: "card-accordion" }, index.h("button", { key: '196ffc3726ea2e8237adfe0a57668aef9fbd3ba6', tabIndex: 0, class: { 'expand-action': true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, index.h("ix-icon", { key: '835870a8c75795ae8e207f07864057a54ef941fd', name: index$1.iconChevronDownSmall, class: {
                'expand-icon': true,
                show: this.expandContent,
            } })), index.h("div", { key: '40ef757e2fa246475abf5f3a2bc37b10b8df7133', class: {
                'expand-content': true,
                show: this.expandContent,
            } }, index.h("div", { key: 'a29f57024b53e01772f1a8f5b6a598a7b47f55d9', class: "expand-content-inner" }, index.h("div", { key: '1a7c42d4e5e20a5b2df1d3df6e46b27618db0543', class: "expand-content-body" }, index.h("slot", { key: '5e28998343ca9cd27c092b4d411b5d370dc3014a' })), index.h("div", { key: '19c4ad7be6afe6b6961538b603311de49d91b01b', class: "expand-content-footer" })))));
    }
...
const CardHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5148c01fc9fd7bae1a4d1ddf353b980498b081e1' }, index.h("slot", { key: '1f97ca5e0f2009f4435bbd46fe84196df762fbc7' }), index.h("div", { key: '9a5207f2155f9579ec60696d02203a8735cd09a3', class: "title-actions" }, index.h("slot", { key: '78e8f6986a6b91b91c19c6a8c34e5849917b4241', name: "title-actions" }))));
    }
};
...
//# sourceMappingURL=ix-card-accordion.ix-card-title.entry.cjs.js.map
