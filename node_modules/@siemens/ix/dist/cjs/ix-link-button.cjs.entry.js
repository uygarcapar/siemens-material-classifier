...
const LinkButton = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2497caf192615ed280d5ae11fdb2ef27060c94f7' }, index.h("a", { key: 'd16ef2ae663fdf36d176e6f59ec909b2b37bc14a', title: this.url, tabindex: "0", class: {
                'link-button': true,
                disabled: this.disabled,
            }, href: this.disabled ? undefined : this.url, target: this.target }, index.h("ix-icon", { key: 'e594f1e55612ef5d7f54f332ad0cff126dc2c7a5', class: "icon", name: index$1.iconChevronRightSmall, size: "16", "aria-hidden": "true" }), index.h("div", { key: 'a96f9d2f232cebbd4ad9036129532f1c9e7e9cd1', class: {
                link: true,
                disabled: this.disabled,
            } }, index.h("slot", { key: 'baf215707505e1ee7afcfae00be962e4d1c6b8e5' })))));
    }
};
LinkButton.style = linkButtonCss;

exports.ix_link_button = LinkButton;
//# sourceMappingURL=ix-link-button.entry.cjs.js.map

//# sourceMappingURL=ix-link-button.cjs.entry.js.map