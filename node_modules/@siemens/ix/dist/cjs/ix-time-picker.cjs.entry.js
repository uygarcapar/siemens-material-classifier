...
const TimePicker = class {
    constructor(hostRef) {
         ...
         */
        this.time = datetime.DateTime.now().toFormat(this.format);
        /**
    ...
    initPicker() {
        ...
        if (!this._time.isValid) {
            ...
            this._time = datetime.DateTime.now();
        }
        this.setTimeRef();
        this.setTimePickerDescriptors();
    ...
    render() {
        return (index.h(index.Host, { key: 'e48a9d540f8a98054afb484e58352e7440a7aad4' }, index.h("ix-date-time-card", { key: '0ee7a6d969ed1560c2396fa9e837505e99d5e4de', standaloneAppearance: this.standaloneAppearance, timePickerAppearance: true, corners: this.corners, hasFooter: true, hideHeader: this.hideHeader }, index.h("div", { key: '8aee7c03adbf74c775bedec4316efc3bbe8d9843', class: "header", slot: "header" }, index.h("ix-typography", { key: 'e80b4718b45f377602c3835939f7e1044374a221', format: "h5" }, this.getHeaderText())), index.h("div", { key: '20f0539b2baaccdac622837bac8bb7076d03cc7b', class: "clock" }, this.timePickerDescriptors.map((descriptor, index$1) => (index.h("div", { class: "flex" }, index.h("div", { class: { columns: true, hidden: descriptor.hidden } }, index.h("div", { class: "column-header", title: descriptor.header }, descriptor.header), index.h("div", { "data-element-list-id": descriptor.unit, class: "element-list", tabIndex: -1 }, descriptor.numberArray.map((number) => (index.h("button", { "data-element-container-id": `${descriptor.unit}-${number}`, class: {
                selected: this.isSelected(descriptor.unit, number),
                'element-container': true,
            }, onClick: () => this.select(descriptor.unit, number), onFocus: () => this.onUnitCellFocus(descriptor.unit, number), onBlur: () => this.onUnitCellBlur(descriptor.unit), tabindex: this.getElementContainerTabIndex(number, descriptor.unit), role: "button", "aria-label": `${descriptor.header}: ${number}` }, this.formatUnitValue(descriptor.unit, number)))), index.h("div", { class: "element-list-padding" }))), index$1 !== this.timePickerDescriptors.length - 1 && (index.h("div", { class: {
                'column-seperator': true,
                hidden: descriptor.hidden,
            } }, this.getColumnSeparator(index$1))))))), index.h("div", { key: 'f9c507d5209e9a8529099d189df7bf6da7adc97b', class: {
                footer: true,
                'footer--compact': this.timePickerDescriptors.length <= 2,
            }, slot: "footer" }, this.timeRef && (index.h("div", { key: 'e3c356b21050f5219b0eba6fccde130aee99a77e', class: {
                'time-ref-buttons': true,
                'time-ref-buttons--datetime-picker-appearance': this.dateTimePickerAppearance,
            } }, index.h("button", { key: '1e804bbba616782cba05647aef54c4bccc2ea5f3', "data-am-pm-id": "AM", class: { selected: this.timeRef === 'AM' }, onClick: () => this.changeTimeReference('AM') }, "AM"), index.h("button", { key: '179ca2df545e89e6f84dc28cadd042d82b63851e', "data-am-pm-id": "PM", class: { selected: this.timeRef === 'PM' }, onClick: () => this.changeTimeReference('PM') }, "PM"))), !this.dateTimePickerAppearance && (index.h("ix-button", { key: '702bb5a2c62d297646045fd0502ec1aabb233355', class: "confirm-button", onClick: () => {
                var _a;
