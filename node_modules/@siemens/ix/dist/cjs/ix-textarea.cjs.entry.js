...
const Textarea = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '1fccaf49740f1452031fcfc92af1b3011eda12a6', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: '1fb5b2a11f7874642bca77fb8ba43932a6ee8f23', required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.textAreaRef }, !!this.maxLength && this.maxLength > 0 && (index.h("ix-typography", { key: '6d6a2cf13f1ec2a45be59812b621ca58d72b35e7', class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_a = this.value) !== null && _a !== void 0 ? _a : '').length, "/", this.maxLength)), index.h("div", { key: '707decc7f3af853270136f752f8e383c7f7af2e1', class: "input-wrapper" }, index.h(input_util.TextareaElement, { key: 'd5dedc1696ef713d049b997c6068b5d18cf266f8', minLength: this.minLength, maxLength: this.maxLength, textareaCols: this.textareaCols, textareaRows: this.textareaRows, textareaHeight: this.textareaHeight, textareaWidth: this.textareaWidth, resizeBehavior: this.resizeBehavior, readonly: this.readonly, disabled: this.disabled, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, textAreaRef: this.textAreaRef, valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
...
exports.ix_textarea = Textarea;
//# sourceMappingURL=ix-textarea.entry.cjs.js.map

//# sourceMappingURL=ix-textarea.cjs.entry.js.map