...
const BreadcrumbItem = class {
    ...
    componentWillLoad() {
        this.a11y = a11y.a11yHostAttributes(this.hostElement, [
            'aria-describedby',
            'aria-controls',
            'aria-expanded',
        ]);
    ...
    render() {
        const props = {
            ...
            ariaAttributes: Object.assign(Object.assign({}, this.a11y), { 'aria-label': this.ariaLabelButton }),
        };
        if (!this.visible) {
            return index.h(index.Host, { class: 'invisible' });
        }
        return (index.h(index.Host, { class: {
                'hide-chevron': !this.showChevron,
            }, onClick: () => this.itemClick.emit(this.label) }, index.h("li", null, index.h(baseButton.BaseButton, Object.assign({}, props, { afterContent: index.h(index.Fragment, null, this.showChevron ? (index.h("ix-icon", { name: index$1.iconChevronRightSmall, size: "16", class: 'chevron' })) : null) }), this.label, index.h("slot", null)))));
    }
...
//# sourceMappingURL=ix-breadcrumb-item.entry.cjs.js.map

//# sourceMappingURL=ix-breadcrumb-item.cjs.entry.js.map