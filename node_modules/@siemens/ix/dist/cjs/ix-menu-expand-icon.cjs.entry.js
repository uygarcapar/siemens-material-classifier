...
const MenuExpandIcon = class {
    ...
    getSmallScreenIcon() {
        return (index.h("button", { class: Object.assign(Object.assign({}, baseButton.getButtonClasses('secondary', false, true, true, false, false, false)), { 'menu-expand-button': true }) }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24", height: "24" }, index.h("rect", { class: "line line-1", x: "2", y: "5", width: "20", height: "2" }), index.h("rect", { class: "line line-2", x: "2", y: "11", width: "13", height: "2" }), index.h("rect", { class: "line line-3", x: "2", y: "17", width: "20", height: "2" }))));
    }
    getLargeScreenIcon() {
        return (index.h("ix-icon-button", { icon: this.expanded ? index$1.iconDoubleChevronLeft : index$1.iconDoubleChevronRight, ghost: true }));
    }
    getMenuIcon() {
        if (this.pinned) {
    ...
    render() {
        return (index.h(index.Host, { key: 'ea63ca6b29ac5da5c70d8aafbee54a4082e0b4f6', class: {
                expanded: this.expanded,
            }, type: "button", "aria-label": this.ixAriaLabel, "aria-pressed": a11y.a11yBoolean(this.expanded) }, this.getMenuIcon()));
    }
};
MenuExpandIcon.style = menuExpandIconCss;

exports.ix_menu_expand_icon = MenuExpandIcon;
//# sourceMappingURL=ix-menu-expand-icon.entry.cjs.js.map

//# sourceMappingURL=ix-menu-expand-icon.cjs.entry.js.map