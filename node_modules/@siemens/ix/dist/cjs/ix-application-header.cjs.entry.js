...
var index$1 = require('./index-BGIxNgwW.js');
...
const ApplicationHeader = class {
    ...
    async showAppSwitch() {
        ...
        this.callbackUpdateAppSwitchModal = await index$1.showAppSwitch((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.appSwitchConfig);
    }
    ...
    render() {
        ...
        const showApplicationSwitch = ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) &&
            this.breakpoint !== 'sm' &&
            this.suppressResponsive === false;
        return (index.h(index.Host, { key: '943e419968b74861f10f3d47fcdc6040fbe00a63', class: {
                [`breakpoint-${this.breakpoint}`]: true,
            }, slot: "application-header" }, (this.showMenu || showMenuByApplicationFrame) && (index.h("ix-menu-expand-icon", { key: '74404541dfcc535f1dc1fadd70bb541ce33167fc', onClick: () => this.onMenuClick(), expanded: this.menuExpanded, ixAriaLabel: this.ariaLabelMenuExpandIconButton })), showApplicationSwitch && (index.h("ix-icon-button", { key: 'd2b6c7451d95c89b44b5ba4b3760fda926932ebe', onClick: () => this.showAppSwitch(), icon: index$2.iconApps, ghost: true, class: "app-switch", "aria-label": this.ariaLabelAppSwitchIconButton })), index.h("div", { key: '3f911d7016457a443a7eac22069e2147c13b6ac0', class: { logo: true } }, index.h("slot", { key: '13f54b750b95a9e737a435d550c9357eb6f6b198', name: "logo" })), index.h("ix-typography", { key: 'ff6dc97826a08e5d0ea0fe7a9da7871271bae808', format: "body-lg", class: "name" }, this.name), index.h("div", { key: '44ab0ff84cfe89cd05a28ca0c87e7a8c29099387', class: "content" }, this.breakpoint === 'sm' ? (index.h(index.Fragment, null, index.h("ix-icon-button", { class: {
                ['context-menu']: true,
                ['context-menu-visible']: this.hasSlottedElements,
            }, "data-context-menu": true, "data-testid": "show-more", icon: index$2.iconMoreMenu, ghost: true, "aria-label": this.ariaLabelMoreMenuIconButton }), index.h("ix-dropdown", { "data-overflow-dropdown": true, class: "dropdown", discoverAllSubmenus: true, trigger: this.resolveContextMenuButton() }, index.h("div", { class: "dropdown-content", onClick: (e) => this.onContentBgClick(e) }, index.h("slot", { onSlotchange: () => this.updateIsSlottedContent() }))))) : (index.h("slot", { onSlotchange: () => this.updateIsSlottedContent() })), index.h("slot", { key: '70fbf85e3dd1a47d6cc69a8892a1da49fd8f079e', name: "ix-application-header-avatar" }))));
    }
...
//# sourceMappingURL=ix-application-header.entry.cjs.js.map
