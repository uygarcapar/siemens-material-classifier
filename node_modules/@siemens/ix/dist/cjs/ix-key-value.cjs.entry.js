...
const KeyValue = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e935470e068f2a55426c8ae8d662e87862b3163d', class: `keyValue keyValue--${this.labelPosition === 'top' ? 'column' : 'row'}` }, this.icon && (index.h("ix-icon", { key: 'e64ed59cb417f83bb959f0be8f02aeec3eecaf9b', name: this.icon, size: "24", class: "keyValue__icon", "aria-label": this.ariaLabelIcon })), index.h("div", { key: '850e89a4a17cf00e740e8541fbbd8161daf7707b', class: "keyValue__content" }, index.h("div", { key: '71a01685512f9fa186a7c426226e2a9e2372662b', class: "content__label" }, this.label), index.h("div", { key: '5170c0809f118bde6ada98a8caf736792c21a0f6', class: {
                content__value: true,
...
//# sourceMappingURL=ix-key-value.entry.cjs.js.map
