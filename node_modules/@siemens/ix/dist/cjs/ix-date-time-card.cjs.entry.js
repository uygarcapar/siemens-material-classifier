...
const DateTimeCard = class {
    ...
    render() {
        return (index.h(index.Host, { key: '31c1aa02530819d8bd9896ca625c3c8930ea8268' }, index.h("div", { key: '31432252f1ce901e76a92423719d24bc621e3e83', class: this.cardClasses() }, !this.hideHeader && (index.h("div", { key: 'dd4b7346375f87a43b2969dba7c5b4a9cc10f0ac', class: "header-container" }, index.h("div", { key: '8dc14769929ce6e0d2f2095ca4904ee8beb2018b', class: "header" }, index.h("slot", { key: '9f5357cb413d5ccf9f6a15ecb10040034ad5e1b0', name: "header" })), index.h("div", { key: 'b7c55ccf1c1f655240d817ed838de53a67a8d4f0', class: "separator" }))), index.h("div", { key: '6ddf415abf2a5174a796e3e9a15441aef0f9c14a', class: {
                content: true,
                'content--time-picker': this.timePickerAppearance,
            } }, index.h("slot", { key: '953b62d7631d68c1061798d6259836110c368095' })), this.hasFooter && (index.h("div", { key: 'd39e55a300835320ef737cd28bce660a846500de', class: "footer-container" }, index.h("div", { key: 'e44823acab4d5a87bcb77ab812e1a31ff6a2b2c7', class: "separator" }), index.h("div", { key: 'e8118c065ed36b219e04a91ec2fe4455585ea2e0', class: "footer" }, index.h("slot", { key: 'f49f852f5b7c6d5bc2052d37593a69e13f78ce0f', name: "footer" })))))));
    }
};
DateTimeCard.style = dateTimeCardCss;

exports.ix_date_time_card = DateTimeCard;
//# sourceMappingURL=ix-date-time-card.entry.cjs.js.map
