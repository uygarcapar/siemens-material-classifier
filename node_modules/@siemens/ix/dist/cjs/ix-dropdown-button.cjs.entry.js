...
const DropdownButton = class {
    ...
    render() {
        return (index.h(index.Host, { key: '00543a45e59fcd3b92ecf159f63f028dcbd5a31f', class: {
                disabled: this.disabled,
            }, ref: this.dropdownAnchor }, index.h("div", { key: '5227219c2fc3ab76c5793554ec73754fc8adfc7a', class: "dropdown-button" }, this.label ? (index.h("ix-button", { variant: this.variant, outline: this.outline, ghost: this.ghost, disabled: this.disabled, alignment: "start", ariaLabel: this.ariaLabelDropdownButton }, index.h("div", { class: 'content' }, this.icon ? (index.h("ix-icon", { name: this.icon, size: "24", class: 'dropdown-icon' })) : null, index.h("div", { class: 'button-label' }, this.label), index.h("ix-icon", { name: this.dropdownShow
                ? index$1.iconChevronUpSmall
                : index$1.iconChevronDownSmall, size: "24" })))) : (index.h("div", null, index.h("ix-icon-button", { icon: this.icon, variant: this.variant, outline: this.outline, ghost: this.ghost, disabled: this.disabled }), this.getTriangle()))), index.h("ix-dropdown", { key: 'f3fd4b3ad7826317851363ba8f0b524e4aa9b705', class: "dropdown", trigger: this.dropdownAnchor.waitForCurrent(), placement: this.placement, closeBehavior: this.closeBehavior, onShowChanged: this.onDropdownShowChanged }, index.h("slot", { key: 'fb95e9c4b60f5951b8bf31ec33aac1df1d8589c3' }))));
    }
...
//# sourceMappingURL=ix-dropdown-button.entry.cjs.js.map
