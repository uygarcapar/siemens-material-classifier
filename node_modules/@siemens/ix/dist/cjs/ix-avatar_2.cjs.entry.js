...
function DefaultAvatar(props) {
    ...
    return (index.h("svg", { class: 'avatar-image', xmlns: "http://www.w3.org/2000/svg", width: "32", height: "32", viewBox: "0 0 32 32", "aria-label": props.a11yLabel }, index.h("g", { fill: "none", "fill-rule": "evenodd" }, index.h("path", { id: "avatar-path-background", d: "M16 0C7.163 0 0 7.163 0 16s7.163 16 16 16 16-7.163\n          16-16c0-4.243-1.686-8.313-4.686-11.314C24.314 1.686 20.244 0 16 0z" }), index.h("path", { id: "avatar-path-person", d: "M17.897 17.91c3.8-.018 7.358 1.875 9.485 5.046-2.417 3.999-6.734 6.434-11.382\n        6.42-4.648.014-8.965-2.421-11.382-6.42 2.127-3.171 5.685-5.064\n        9.485-5.045h3.794zM15.821 2.129c3.682 0 6.667 2.984 6.667 6.666 0 3.682-2.985\n        6.667-6.667 6.667s-6.667-2.985-6.667-6.667 2.985-6.666 6.667-6.666z" }))));
}
function AvatarImage(props) {
    return (index.h("div", { class: "avatar" }, props.image ? (index.h("img", { src: props.image, class: "avatar-image", "aria-label": props.a11yLabel })) : (index.h(DefaultAvatar, { initials: props.initials, a11yLabel: props.a11yLabel }))));
}
function UserInfo(props) {
    return (index.h(index.Fragment, null, index.h("div", { class: "user-info", onClick: (event) => event.preventDefault() }, index.h(AvatarImage, { image: props.image, initials: props.initials, a11yLabel: props.a11yLabel }), index.h("div", { class: "user" }, index.h("div", { class: "username" }, props.userName), props.extra && (index.h("ix-typography", { class: "extra", "text-color": 'soft' }, props.extra))))));
}
const Avatar = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        const a11yLabel = a11y$1['aria-label'];
        if (this.isClosestApplicationHeader) {
            return (index.h(index.Host, { slot: "ix-application-header-avatar", class: 'avatar-button' }, index.h(baseButton.BaseButton, { disabled: false, ghost: true, iconOval: false, icon: undefined, iconOnly: false, loading: false, outline: false, selected: false, type: "button", variant: "primary" }, index.h(AvatarImage, { image: this.image, initials: this.initials, a11yLabel: a11yLabel !== null && a11yLabel !== void 0 ? a11yLabel : this.a11yLabel })), index.h("ix-dropdown", { ref: (ref) => (this.dropdownElement = ref), trigger: this.resolveAvatarTrigger(), class: "avatar-dropdown", onClick: (e) => this.onDropdownClick(e) }, this.username && (index.h(index.Fragment, null, index.h(UserInfo, { extra: this.extra, image: this.image, initials: this.initials, userName: this.username, a11yLabel: a11yLabel !== null && a11yLabel !== void 0 ? a11yLabel : this.a11yLabel }), this.hasSlottedElements && (index.h("ix-divider", { onClick: (e) => e.preventDefault() })))), index.h("slot", { onSlotchange: () => this.slottedChanged(), ref: (ref) => (this.slotElement = ref) }))));
        }
        return (index.h(index.Host, null, index.h(AvatarImage, { image: this.image, initials: this.initials, a11yLabel: a11yLabel !== null && a11yLabel !== void 0 ? a11yLabel : this.a11yLabel })));
    }
...
const MenuAvatarItem = class {
    ...
    render() {
        return (index.h("ix-dropdown-item", { key: '9283341aa90956527e281ea9a55991765f993cd4', ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) }));
    }
    get hostElement() { return index.getElement(this); }
};
...
//# sourceMappingURL=ix-avatar.ix-menu-avatar-item.entry.cjs.js.map
