...
const Drawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '32e7b35e661a989b1fcd828e983c1ebabb42c343', class: {
                ...
                overflow: 'hidden',
            }, ref: (el) => (this.divElement = el), "data-testid": "container", id: "div-container" }, index.h("div", { key: '42bac01b9ddcbab6459439dd41fb8262b84ca84b', style: {
                width: this.width === 'auto'
                    ? 'auto'
                    : `${this.getConstrainedWidth(this.width)}rem`,
            } }, index.h("div", { key: '1ceac8c1a382d567b9aa8f1dd4480deff7ba1bec', class: "header" }, index.h("div", { key: 'd13ed813a31f1ff4e0bf05b6222e5be18b4200c5', class: "header-content" }, index.h("slot", { key: '7880442d02332011865b8766066aedc21f49e231', name: "header" })), index.h("ix-icon-button", { key: 'db4411ec680abc247991d584c9b3834089799c29', class: "close-button", style: {
                display: this.showContent ? 'block' : 'none',
            }, icon: index$1.iconClose, size: "24", ghost: true, onClick: () => this.onCloseClicked(), "data-testid": "close-button", "aria-label": this.ariaLabelCloseButton })), index.h("div", { key: 'b3c376be2616225a3f882e797eec0f506e2414bf', class: "content", style: {
                display: this.showContent ? 'block' : 'none',
            } }, index.h("slot", { key: '55be1dc533ba105af5195238c013aa27b63f45c3' })))));
    }
...
//# sourceMappingURL=ix-drawer.entry.cjs.js.map
