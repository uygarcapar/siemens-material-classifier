...
const Modal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6276024ffdf610b2d8a60f63acea097dda5f6497', class: {
                visible: this.modalVisible,
                'no-backdrop': this.backdrop === false,
                'align-center': this.centered,
            } }, index.h("div", { key: '6005a642f953d4a8f950bdff5d5a86fe36c5b46d', class: "dialog-backdrop" }, index.h("dialog", { key: 'c220e0ffe509b7d18cde527c3667e4f195477b9c', "aria-modal": a11y.a11yBoolean(true), "aria-describedby": this.ariaAttributes['aria-describedby'], "aria-labelledby": this.ariaAttributes['aria-labelledby'], class: {
                modal: true,
                [`modal-size-${this.size}`]: true,
            }, onClose: () => this.dismissModal(), onMouseDown: (event) => this.onMouseDown(event), onMouseUp: (event) => this.onMouseUp(event), onCancel: (e) => {
                e.preventDefault();
                this.dismissModal();
            } }, index.h("slot", { key: 'd09a8ba436da4d63c357426dee438bf175582fba' })))));
    }
    get hostElement() { return index.getElement(this); }
};
__decorate([
    listener.OnListener('keydown', (self) => !self.closeOnEscape)
], Modal.prototype, "onKey", null);
Modal.style = modalCss;

exports.ix_modal = Modal;
//# sourceMappingURL=ix-modal.entry.cjs.js.map
