...
const FilterChip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ce879b98f05bff992dd29c546dd9dc8f1a51dcf3', class: { disabled: this.disabled, readonly: this.readonly }, title: this.hostElement.textContent }, index.h("div", { key: 'd79937000b36b929ffb29b659fba7558cf20d86d', class: "slot-container" }, index.h("slot", { key: 'cfbff57b1bad2f5103e4911141ed0fa2785c31ec' })), !this.disabled && !this.readonly ? (index.h("ix-icon-button", { ghost: true, oval: true, icon: index$1.iconCloseSmall, size: "16", tabindex: this.disabled ? -1 : 0, variant: "primary", disabled: this.disabled, onClick: (e) => this.onCloseClick(e), "aria-label": this.ariaLabelCloseIconButton })) : null));
    }
...
const SelectItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '19f50b530d04e8ea3ba6b5eb759d214446b9cdad' }, index.h("ix-dropdown-item", { key: '2677202fb6a5db694bc546ad2ad5b2f3402242cf', class: {
...
//# sourceMappingURL=ix-filter-chip.ix-select-item.entry.cjs.js.map
