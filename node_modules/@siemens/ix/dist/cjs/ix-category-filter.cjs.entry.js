...
var baseButton = require('./base-button-G3EyGW_x.js');
...
const CategoryFilter = class {
    constructor(hostRef) {
        ...
        this.filterCleared = index.createEvent(this, "filterCleared", 7);
        this.ID_CUSTOM_FILTER_VALUE = 'CW_CUSTOM_FILTER_VALUE';
        this.textInput = makeRef.makeRef();
    ...
    componentDidLoad() {
        ...
        if (this.formElement !== undefined) {
            this.formKeyDownListener = disposableEventListener.addDisposableEventListener(this.formElement, 'keydown', ((e) => this.handleFormElementKeyDown(e)));
            this.preventDefaultListener = disposableEventListener.addDisposableEventListener(this.formElement, 'submit', this.preventDefault);
        }
        ...
        this.inputKeyDownListener = disposableEventListener.addDisposableEventListener(this.textInput.current, 'keydown', ((e) => this.handleInputElementKeyDown(e)));
        this.focusInListener = disposableEventListener.addDisposableEventListener(this.textInput.current, 'focusin', () => this.onFocusIn());
        this.focusOutListener = disposableEventListener.addDisposableEventListener(this.textInput.current, 'focusout', () => this.onFocusOut());
        this.inputListener = disposableEventListener.addDisposableEventListener(this.textInput.current, 'input', () => this.onInput());
    }
    ...
    getFilterOperatorString() {
        ...
        return `${operator === logicalFilterOperator.LogicalFilterOperator.EQUAL ? '=' : '!='} `;
    }
    renderCategoryValues() {
        ...
        return (index.h("div", { class: "dropdown-item-container" }, this.renderOperatorButton(), index.h("div", { class: "dropdown-header" }, (_a = this.categories[this.category]) === null || _a === void 0 ? void 0 : _a.label), (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 :
            _b.options.filter((value) => this.filterByInput(value)).filter((value) => this.filterDuplicateTokens(value)).map((id) => (index.h("button", { class: "dropdown-item category-item-value", "data-id": id, title: id, key: id, onClick: (e) => {
                    e.preventDefault();
    ...
    renderCategorySelection() {
        var _a;
        return (index.h("div", { class: "dropdown-item-container" }, (_a = this.getCategoryIds()) === null || _a === void 0 ? void 0 : _a.filter((id) => this.categories && this.filterByInput(this.categories[id].label)).filter((id) => this.filterMultiples(id)).map((id) => {
            var _a, _b, _c, _d;
            return (index.h("button", { class: "dropdown-item category-item category-item-id", "data-id": id, title: (_b = (_a = this.categories) === null || _a === void 0 ? void 0 : _a[id]) === null || _b === void 0 ? void 0 : _b.label, key: id, onClick: (e) => {
                    e.preventDefault();
    ...
    getResetButton() {
        return (index.h("ix-icon-button", { onClick: (e) => this.resetFilter(e), class: {
            ...
            }, ghost: true, oval: true, icon: index$1.iconClear, size: "16", "aria-label": this.ariaLabelResetButton }));
    }
    getIconColor() {
        if (this.disabled) {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '159b06287f95ae0d34ffa4be4f6b347e236572be' }, index.h("form", { key: '33af16253af787446418717f4c3fbd8487dccc68', ref: (el) => (this.formElement = el) }, index.h("div", { key: 'f2a6119389dbba984c7fd446d1a9ef8c26a03521', "read-only": this.readonly, class: {
                'input-container': true,
                disabled: this.disabled,
                focus: this.hasFocus,
                readonly: this.readonly,
                'no-icon': this.hideIcon,
            } }, index.h("ix-icon", { key: 'c5ea70962ecafc8c5e64e935fcdc3be110c9f48e', color: this.getIconColor(), class: { 'display-none': this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : index$1.iconSearch, size: "16" }), index.h("div", { key: '7a804155cbb780c989dd7e56de656c70451d4aa3', class: "token-container" }, index.h("div", { key: 'bba13d7d6e4d497f77c7a399b1ef9eb674150942', class: "list-unstyled" }, this.filterTokens.map((value, index$1) => (index.h("span", { key: value.toString(), class: {
                animate__animated: true,
                animate__fadein: true,
            } }, index.h("ix-filter-chip", { disabled: this.disabled, readonly: this.readonly, onClick: (e) => e.stopPropagation(), onCloseClick: () => this.removeToken(index$1) }, this.getFilterChipLabel(value))))), this.categories === undefined ? ('') : (index.h("span", { class: {
                'category-preview': true,
                'display-none': this.category === '',
            } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label)), index.h("input", Object.assign({ key: '4f102ead6f9bcc711410eec5693a9da97e2bb2ba', class: {
                'text-input': true,
                'hide-placeholder': this.readonly || this.disabled || this.category !== '',
            }, autocomplete: "off", name: "category-filter-input", disabled: this.disabled, readonly: this.readonly, ref: this.textInput, type: "text", placeholder: this.placeholder }, this.a11yAttributes, { "aria-label": this.ariaLabelFilterInput })))), !this.readonly && !this.disabled && this.getResetButton())), this.disabled || this.readonly ? ('') : (index.h("ix-dropdown", { show: this.showDropdown, closeBehavior: "outside", offset: { mainAxis: 2 }, anchor: (_c = this.textInput) === null || _c === void 0 ? void 0 : _c.waitForCurrent(), trigger: this.hostElement, header: this.getDropdownHeader() }, this.renderDropdownContent()))));
    }
...
//# sourceMappingURL=ix-category-filter.entry.cjs.js.map
