...
const GroupContextMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '78dbddb5af2b2de9f2fe91e7aa1d69b1993ad29b' }, index.h("ix-icon-button", { key: 'c5b68ac445c5390ff0d42cce43ee6b96b875930b', class: { hide: !this.showContextMenu }, size: "24", ghost: true, icon: index$1.iconContextMenu }), index.h("slot", { key: 'fadd0b375491eea9ebc4f1008901d05c16c90e07', onSlotchange: () => this.onSlotChange() })));
    }
...
const GroupItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2732425af033697e8e7b588994288680f5879283', class: {
                selected: this.selected && !this.suppressSelection,
            } }, index.h("button", { key: '102d7b64afa96797dbec34e278dbc53c88be5ddc', tabindex: this.focusable ? 0 : -1 }, index.h("div", { key: '2960ae9691db17b0a20782b75f49b16c6a623116', class: "group-entry-selection-indicator" }), this.icon ? (index.h("ix-icon", { size: "16", name: this.icon, "aria-label": this.ariaLabelIcon })) : null, this.text ? (index.h("span", { class: "group-entry-text" }, index.h("span", { title: this.text }, this.text))) : null, this.secondaryText ? (index.h("span", { class: "group-entry-text-secondary" }, index.h("span", { title: this.secondaryText }, this.secondaryText))) : null, index.h("slot", { key: 'c2d7675bbd9b5c3463f202893910f63b7fccc9c6' }))));
    }
    get hostElement() { return index.getElement(this); }
};
...
//# sourceMappingURL=ix-group-context-menu.ix-group-item.entry.cjs.js.map
