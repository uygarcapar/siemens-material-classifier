...
const Checkbox = class {
    constructor(hostRef) {
        ...
        this.required = false;
        this.touched = false;
        this.inputRef = makeRef.makeRef((checkboxRef) => {
    ...
    renderCheckmark() {
        return (index.h("svg", { width: "18", height: "18", viewBox: "0 0 18 18", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, this.indeterminate && (index.h(index.Fragment, null, index.h("rect", { width: "18", height: "18", fill: "transparent" }), index.h("rect", { x: "3", y: "8", width: "12", height: "2", fill: "var(--ix-checkbox-check-color)" }))), this.checked && (index.h("path", { d: "M3.65625 8.15625L8.4375 12.9375L14.625 3.9375", stroke: "var(--ix-checkbox-check-color)", "stroke-width": "2" }))));
    }
    render() {
        return (index.h(index.Host, { key: 'edd3e1db46df2972d32c7163e9ec8cea31ab1442', "aria-checked": a11y.a11yBoolean(this.checked), "aria-disabled": a11y.a11yBoolean(this.disabled), role: "checkbox", class: {
                disabled: this.disabled,
                checked: this.checked,
                indeterminate: this.indeterminate,
            }, onFocus: () => (this.touched = true), onBlur: () => this.ixBlur.emit() }, index.h("label", { key: '4613265c56703e7492610ec4628292acaa1d687a' }, index.h("input", { key: '7aa0618e7587d985033ff91aa12830a068d87bc5', "aria-checked": a11y.a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), index.h("button", { key: '77ef1f2cd6ca06a41e19553eeb74a5c016dee5db', disabled: this.disabled, class: {
                checked: this.checked,
            }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark()), index.h("ix-typography", { key: '951668fe3462fcf3b739b74f8329259a245165f3', format: "label", textColor: this.disabled ? 'weak' : 'std' }, this.label, index.h("slot", { key: '7ecee7334a8b9fa3d37a2f7bf166caf793fe6ccb' })))));
    }
...
exports.ix_checkbox = Checkbox;
//# sourceMappingURL=ix-checkbox.entry.cjs.js.map

//# sourceMappingURL=ix-checkbox.cjs.entry.js.map