...
const NumberInput = class {
    ...
    updatePaddings() {
        input_util.adjustPaddingForStartAndEnd(this.slotStartRef.current, this.slotEndRef.current, this.inputRef.current);
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '84922a792a200ffae10318e43d583f513f8f54a0', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: '99e34a8e83e84f57622caf957a6efc748b4e3961', id: this.numberInputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, index.h("div", { key: '773c88e5db1e487dd8dd51f761e81d00de7a7f58', class: {
                'input-wrapper': true,
                'show-stepper-buttons': !!this.showStepperButtons,
            } }, index.h(input_util.SlotStart, { key: '2c88980ec7af235ffbaf9a8f326bf2200336c4d3', slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), index.h(input_util.InputElement, { key: '72b9cc1cacee54b359b5e364acdfd953b32cd7a3', id: this.numberInputId, readonly: this.readonly, disabled: this.disabled, step: this.step, min: this.min, max: this.max, pattern: this.pattern, type: 'number', isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => input_util.checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(Number(value)), updateFormInternalValue: (value) => this.updateFormInternalValue(Number(value)), onBlur: () => {
                input_util.onInputBlur(this, this.inputRef.current);
                this.touched = true;
            } }), index.h(input_util.SlotEnd, { key: 'f46f67c4682b726d5bd8d74e04c91523ddacbede', slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, index.h("div", { key: 'bb6b489d4e94014089c0bce9b00089eea65fc0e4', class: {
                'number-stepper-container': true,
                'container-hidden': !showStepperButtons,
            } }, index.h("ix-icon-button", { key: '2c6d0b537f6a1364fe49a7b41d2bda6b0ecbc62d', ghost: true, icon: index$1.iconMinus, size: "16", class: "number-stepper-button step-minus", "aria-label": "decrement number", onClick: () => {
            ...
            } }), index.h("ix-icon-button", { key: '2fd3710a054233ab5913816fde0186a476476474', ghost: true, icon: index$1.iconPlus, size: "16", class: "number-stepper-button step-plus", "aria-label": "increment number", onClick: () => {
                if (!this.inputRef.current) {
                    return;
                }
...
exports.ix_number_input = NumberInput;
//# sourceMappingURL=ix-number-input.entry.cjs.js.map

//# sourceMappingURL=ix-number-input.cjs.entry.js.map