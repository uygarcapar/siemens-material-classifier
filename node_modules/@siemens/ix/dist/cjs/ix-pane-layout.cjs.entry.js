...
const Panes = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a372c27b25dc920eb19525cead2589dcbc0af652' }, !this.isMobile ? (this.layout == 'full-vertical' ? (index.h("div", { class: "side-panes-wrapper" }, index.h("div", { class: {
                row: true,
            ...
            } }, index.h("div", { key: "top", class: { 'absolute-top': this.isFloating('top') } }, index.h("slot", { name: "top" })), index.h("div", { key: "content", class: "content", onClick: () => this.closeFloatingPanes() }, index.h("slot", { name: "content" }), index.h("slot", null)), index.h("div", { key: "bottom", class: { 'absolute-bottom': this.isFloating('bottom') } }, index.h("slot", { name: "bottom" }))), index.h("div", { key: "right", class: { 'absolute-right': this.isFloating('right') } }, index.h("slot", { name: "right" }))))) : (index.h("div", { class: "side-panes-wrapper" }, index.h("div", { class: {
                col: true,
                'padding-top': this.hasPadding('top'),
                'padding-bottom': this.hasPadding('bottom'),
                ...
                'padding-left': this.hasPadding('left'),
                'padding-right': this.hasPadding('right'),
            } }, index.h("div", { key: "left", class: { 'absolute-left': this.isFloating('left') } }, index.h("slot", { name: "left" })), index.h("div", { key: "content", class: "content", onClick: () => this.closeFloatingPanes() }, index.h("slot", { name: "content" }), index.h("slot", null)), index.h("div", { key: "right", class: { 'absolute-right': this.isFloating('right') } }, index.h("slot", { name: "right" }))), index.h("div", { key: "bottom", class: { 'absolute-bottom': this.isFloating('bottom') } }, index.h("slot", { name: "bottom" })))))) : (index.h("div", { class: "col" }, index.h("div", { key: "top", style: {
            ...
            } }, index.h("slot", { name: "left" })), index.h("div", { key: "content", class: "content", onClick: () => this.closeFloatingPanes() }, index.h("slot", { name: "content" }), index.h("slot", null)), index.h("div", { key: "right", style: {
...
//# sourceMappingURL=ix-pane-layout.entry.cjs.js.map
