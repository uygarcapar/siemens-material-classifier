...
const DropdownHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cd107d89cbb21bf785b8b3eac11a46254128eee2' }, index.h("ix-typography", { key: 'f19132492b63e43cb3fed1fa32f0532e6b02ae7f', class: 'category-text', format: 'h5' }, this.label)));
    }
};
DropdownHeader.style = dropdownHeaderCss;

exports.ix_dropdown_header = DropdownHeader;
//# sourceMappingURL=ix-dropdown-header.entry.cjs.js.map
