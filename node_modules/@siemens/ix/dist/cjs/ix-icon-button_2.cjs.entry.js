...
var baseIconButton = require('./base-icon-button-CfhmHL0H.js');
var a11y = require('./a11y-B_6chCvu.js');
require('./base-button-G3EyGW_x.js');
...
const IconButton = class {
    ...
    render() {
        ...
        const baseButtonProps = {
            ariaAttributes: {
                'aria-label': (_b = (_a = a11y$1['aria-label']) !== null && _a !== void 0 ? _a : this.a11yLabel) !== null && _b !== void 0 ? _b : a11y.getFallbackLabelFromIconName(this.icon),
            },
        ...
        return (index.h(index.Host, { key: '0b737ab8859e3299f049a0740dee0acf906387ac', class: Object.assign(Object.assign({}, this.getIconSizeClass()), { disabled: this.disabled || this.loading }) }, index.h(baseIconButton.BaseIconButton, Object.assign({ key: 'ba7a73d22f1d9c8c4a73027c8c40205ae48cb787' }, baseButtonProps))));
    }
...
const Spinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '60f00971cbb88210fdb31f2ca873110e09abe681' }, index.h("div", { key: '25625ef5ff443bb582e8ab023d12f0575e6ee27f', class: {
...
//# sourceMappingURL=ix-icon-button.ix-spinner.entry.cjs.js.map
