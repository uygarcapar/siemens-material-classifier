...
const Tree = class {
        ...
        return {
            ...
            generate: (index) => {
                ...
                if (innerElement === null) {
                    innerElement = tree_types.renderDefaultItem(item, context, update);
                }
     ...
     */
    async refreshTree(options = tree_types.defaultRefreshTreeOptions) {
        if (this.hyperlist) {
    ...
    initList() {
        ...
        (_a = this.hyperlist) === null || _a === void 0 ? void 0 : _a.destroy();
        const config = this.getVirtualizerOptions(tree_types.defaultRefreshTreeOptions);
    ...
    onTreeItemClick(event) {
        ...
        const hasTrigger = dropdownController.dropdownController.pathIncludesTrigger(treePath);
        if (hasTrigger) {
            return;
        }
    ...
    render() {
        return (index.h(index.Host, { key: '0a642ed3a475a8c117ab43fc91804ed6b10d7ed7', onClick: (event) => this.onTreeItemClick(event) }, index.h("slot", { key: '7154de184c8439c3047277415e78a6d45f6ccc5c' })));
    }
...
//# sourceMappingURL=ix-tree.entry.cjs.js.map
