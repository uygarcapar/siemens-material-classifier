...
const Kpi = class {
    ...
    getStateIcon() {
        switch (this.state) {
            case 'alarm':
                return (index.h("ix-icon", { color: "kpi-display-icon--color", name: index$1.iconAlarm, size: "16", "aria-label": this.ariaLabelAlarmIcon }));
            case 'warning':
                return (index.h("ix-icon", { color: "kpi-display-icon--color", name: index$1.iconWarning, size: "16", "aria-label": this.ariaLabelWarningIcon }));
            default:
                return '';
        }
    }
    ...
    render() {
        return (index.h(index.Host, { key: '39b506cd4cca2dc11321a641226950472f1a5b88', title: this.getTooltipText(), tabindex: "1", class: {
                stacked: this.orientation === 'vertical',
            } }, index.h("div", { key: 'e16287626d7db1f502374e32244a0b733938cab5', class: {
                'kpi-container': true,
                alarm: this.state === 'alarm',
                warning: this.state === 'warning',
            } }, index.h("span", { key: '8e3fdd763c6b3f94566f8f06f21dc8c557b483ef', class: "kpi-label" }, this.getStateIcon(), index.h("span", { key: '27c435f6d6a740857f56b156a956ea1e02830697', class: "kpi-label-text" }, this.label)), index.h("span", { key: 'bb60cbd03af39f06701e89dd2daaec14f8ba9189', class: "kpi-value-container" }, index.h("span", { key: '8a951fd891d57b0b5e4abdddc7de30bf679c7020', class: "kpi-value" }, this.value), this.unit ? index.h("span", { class: "kpi-unit" }, this.unit) : ''))));
    }
};
Kpi.style = kpiCss;

exports.ix_kpi = Kpi;
//# sourceMappingURL=ix-kpi.entry.cjs.js.map
