...
const Pagination = class {
    ...
    getPageButton(index$1) {
        const baseButtonProps = Object.assign(Object.assign({}, this.baseButtonConfig), { onClick: () => this.selectPage(index$1), selected: this.selectedPage === index$1, ariaAttributes: {
                'aria-pressed': a11y.a11yBoolean(this.selectedPage === index$1),
            } });
        return index.h(baseButton.BaseButton, Object.assign({}, baseButtonProps), index$1 + 1);
    }
    renderPageButtons() {
        ...
        if (hasOverflowStart) {
            ...
            pageButtons.push(index.h(baseButton.BaseButton, Object.assign({}, baseButtonProps), "..."));
            if (hasOverflowEnd) {
    ...
    render() {
        return (index.h(index.Host, { key: 'cee334d6fc3f6bfc5a9bbd7f7777fb6104229767' }, index.h("ix-icon-button", { key: 'e4e2ec8ecff9e61dbf492b62d55e60958e2af3f8', disabled: !this.count || this.selectedPage === 0, ghost: true, icon: index$1.iconChevronLeftSmall, onClick: () => this.decrease(), "aria-label": this.ariaLabelChevronLeftIconButton }), this.advanced ? (index.h("div", { class: "advanced-pagination" }, index.h("ix-typography", { format: "body" }, this.i18nPage), index.h("input", { class: "ix-form-control page-selection", type: "number", min: "1", max: this.count, value: this.selectedPage + 1, onChange: (event) => {
                const eventTarget = event.target;
                if (eventTarget) {
                    const index = Number.parseInt(eventTarget.value);
                    this.selectPage(index - 1);
                }
            } }), index.h("span", { class: "total-count" }, index.h("ix-typography", { format: "body" }, this.i18nOf, " ", this.count)))) : (index.h("span", { class: "basic-pagination" }, this.renderPageButtons(), " ")), index.h("ix-icon-button", { key: 'e0035e1f9b9c18bb3ad2edfb489a171c5ac1ded3', disabled: !this.count || this.selectedPage === this.count - 1, ghost: true, icon: index$1.iconChevronRightSmall, onClick: () => this.increase(), "aria-label": this.ariaLabelChevronRightIconButton }), this.advanced && this.showItemCount ? (index.h("span", { class: "item-count" }, index.h("ix-typography", { format: "body" }, this.i18nItems), index.h("ix-select", { hideListHeader: true, i18nPlaceholder: "", i18nSelectListHeader: "", value: `${this.itemCount}`, onValueChange: (e) => {
...
//# sourceMappingURL=ix-pagination.entry.cjs.js.map
