...
const TreeItem = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'da96cf807a161f1c052c54088abd6d33dedb2e6e', class: {
                selected: !!((_a = this.context) === null || _a === void 0 ? void 0 : _a.isSelected),
            } }, index.h("div", { key: '2859b719297a89c092b977d4f35e51034cb48dfb', class: "icon-toggle-container" }, this.hasChildren ? (index.h("ix-icon", { name: index$1.iconChevronRightSmall, size: "24", class: {
                ['icon-toggle-down']: !!((_b = this.context) === null || _b === void 0 ? void 0 : _b.isExpanded),
            }, color: "color-std-text", onClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.toggle.emit();
            }, "aria-label": this.ariaLabelChevronIcon })) : null), index.h("div", { key: '0ba682812fec0226ddb3e11842fe4e039e16946f', class: "tree-node-container", onClick: () => {
                this.itemClick.emit();
            } }, index.h("div", { key: '1810765c042ca82c17065184cc4e41d6f1209dd1', class: "tree-node-text" }, this.text), index.h("slot", { key: 'c302d605d35d8d71a3e81010e6d9cd00f0dac50d' }))));
    }
};
TreeItem.style = treeItemCss;

exports.ix_tree_item = TreeItem;
//# sourceMappingURL=ix-tree-item.entry.cjs.js.map
