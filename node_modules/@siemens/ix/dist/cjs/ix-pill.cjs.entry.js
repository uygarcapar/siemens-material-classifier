...
const Pill = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '91fe8f25736d817d1533b177b616da98c0d4dbb1', style: this.variant === 'custom'
                ? {
                    '--ix-icon-button-color': this.pillColor,
                }
                : {}, class: {
                'align-left': this.alignLeft,
            } }, index.h("div", { key: 'd36daaf4c47be324efbaa578af6c3ca34d8535cd', ref: this.containerElementRef, style: Object.assign({}, customStyle), class: {
                container: true,
            ...
            } }, this.icon && (index.h("ix-icon", { key: '156ce9b506e2a5820a2e119b622f27e9df2e2970', class: {
                'with-icon': true,
            }, name: this.icon, size: '16', "aria-label": this.ariaLabelIcon })), index.h("span", { key: 'e6c085a0694ab6a8158715b8c7fb3d67bab4f36a', class: "slot-container" }, index.h("slot", { key: 'c2b5c8caaee3de9210c24ae51424d9748bd65315', onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip()));
    }
...
//# sourceMappingURL=ix-pill.entry.cjs.js.map
