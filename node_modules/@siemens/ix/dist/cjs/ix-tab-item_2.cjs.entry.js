...
const TabItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5f99427e72341c777cb118dcbcd7587293c1b691', class: this.tabItemClasses({
            ...
            } }, index.h("div", { key: '361559a66388b001472212ae7e2ecf9e164f8440', class: {
                circle: this.rounded,
                text: !this.rounded,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("slot", { key: '94e209864ffbe284a8491d0059cd40bb70bddef3' })), index.h("div", { key: '27b5d1b3691d5086c15449936769e373bb3c6d1b', class: {
                counter: true,
                selected: this.selected,
...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '006d0df46e7fb72bba7750e90d709b4c323bc6a6' }, this.showArrowPrevious && (index.h("button", { key: 'b183a2383341ce9db92fd07b8909799b1e2a63a6', class: "arrow", onClick: () => this.move(this.scrollAmount, true), "aria-label": this.ariaLabelChevronLeftIconButton }, index.h("ix-icon", { key: '467e98afc98432db39f41e3de219bea7503b701e', name: index$1.iconChevronLeftSmall }))), index.h("div", { key: '3e74a31123c9f77de6931953a324c181ffc52078', class: {
                'tab-items': true,
            ...
            } }, index.h("div", { key: '693d4b2b33a92b7214061d127918ce3fd6e1e2b2', class: "items-content" }, index.h("slot", { key: '85c53b1f37d57866f8553a07998243120709609e' }))), this.showArrowNext && (index.h("button", { key: '0db766e3067260376a3463c43867b346c147a1a1', class: "arrow right", onClick: () => this.move(-this.scrollAmount, true), "aria-label": this.ariaLabelChevronRightIconButton }, index.h("ix-icon", { key: 'cc29216e2313ba8bcd739eb306b5386dc5cd911e', name: index$1.iconChevronRightSmall })))));
    }
...
//# sourceMappingURL=ix-tab-item.ix-tabs.entry.cjs.js.map
