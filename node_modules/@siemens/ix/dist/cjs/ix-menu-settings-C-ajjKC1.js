...
const MenuSettings = class {
    ...
    render() {
        return index.h(MenuTabs, { key: 'a59dd5a81b91ff4ae7f516cb192700bffaee3f84', context: this });
    }
...
const getTabItems = (context) => {
    return context.items.map(({ label }) => {
        return (index.h("ix-tab-item", { selected: label === context.activeTabLabel, onTabClick: (e) => e.preventDefault(), onClick: () => {
                if (label) {
...
const MenuTabs = ({ context }) => {
    ...
    return (index.h(index.Host, { slot: context instanceof MenuSettings ? 'ix-menu-settings' : 'ix-menu-about', class: {
            show: context.show,
        } },
        index.h("div", { class: context instanceof MenuSettings ? 'settings-header' : 'about-header' },
            index.h("h2", { class: "text-h2" }, context.label),
            index.h("ix-icon-button", { ghost: true, size: "24", icon: index$1.iconClose, onClick: (e) => context.close.emit({
                    name: context instanceof MenuSettings
                        ? 'ix-menu-settings'
                        : 'ix-menu-about',
                    nativeEvent: e,
                }) })),
        index.h("ix-tabs", { selected: selectedIndex !== -1 ? selectedIndex : 0 }, getTabItems(context)),
        index.h("slot", null)));
};
...
//# sourceMappingURL=ix-menu-settings-C-ajjKC1.js.map
