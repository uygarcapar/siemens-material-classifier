...
const Group = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd082d22d88ff20f978bf888c1954018ccb334340' }, index.h("div", { key: '95ad654ab3ba0ba95c03f58a12410716cbedcf69', class: {
                'group-header': true,
                expand: !this.collapsed,
                selected: this.selected,
            }, tabindex: "0" }, index.h("div", { key: '23ed93c470074df12a5d4d288c24d46fb4f8e540', class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, index.h("div", { key: '6038f9cce575f66b665b2590b53f45583dbec56c', class: {
                'group-header-selection-indicator': true,
                'group-header-selection-indicator-item-selected': this.itemSelected,
            } }), index.h("div", { key: '267dbac1dd05b836d2e02c7eadafcc9e85728bfb', class: "btn-expand-header" }, index.h("ix-icon", { key: 'adee543f2ffdfde656850bbaf72b0f7a9ade40b3', "data-testid": "expand-collapsed-icon", class: {
                hidden: !this.showExpandCollapsedIcon,
            }, name: this.collapsed ? index$1.iconChevronDownSmall : index$1.iconChevronUpSmall, onClick: (event) => this.onExpandClick(event) })), index.h("div", { key: 'd61c48ca2278eefabfb29a4a7f95ba8679bddea8', class: "group-header-content" }, this.header ? (index.h("div", { class: "group-header-props-container" }, index.h("div", { class: "group-header-title" }, index.h("span", { title: this.header }, this.header)), index.h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader))) : null, index.h("slot", { key: 'f9ef67f6d5d5502c01eb3c951f24f00f9ea4f430', name: "header" }))), this.hasDropdown && (index.h("ix-group-context-menu", { key: '9b72c63b4a96b7ad856c5c76de9a8aa2ac7edd60' }, index.h("slot", { key: '0ab6d7702e840833c92dad199fc938af5ca768bd', name: "dropdown" })))), index.h("div", { key: 'fe98c2dbc88d0d4845e29567e34cb8bed64c7f08', class: {
                'group-content': true,
            } }, index.h("div", { key: '52f5543335083fea7692df593cbb61e0e7dde85e', style: {
                display: this.collapsed ? 'none' : 'contents',
            } }, index.h("slot", { key: '87a93624ea3663137d2960b35f2f3649c3d6d2a0', onSlotchange: () => {
                var _a;
                const slot = (_a = this.hostElement.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('slot:not([name])');
                this.showExpandCollapsedIcon = shadowDom.hasSlottedElements(slot);
            } }), index.h("ix-group-item", { key: 'f32edf031e8e6b6edf2748cb2b805e8440bba231', suppressSelection: true, focusable: false, class: {
                footer: true,
                'footer-visible': this.footerVisible,
            } }, index.h("slot", { key: '9b7510bedc970fe093496f055c97c32c715bcba8', name: "footer", onSlotchange: () => this.onSlotChange() }))))));
    }
...
//# sourceMappingURL=ix-group.entry.cjs.js.map
