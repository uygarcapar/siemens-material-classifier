...
const RadiobuttonGroup = class {
    ...
    render() {
        return (h(Host, { key: '0cadba0159ce31d3c7976745b2587e65c4a3790b', onIxBlur: () => (this.touched = true), ref: this.groupRef }, h("ix-field-wrapper", { key: 'f271cb0195f0a6a3f30ba2d7d76b15724b5508f2', label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, h("div", { key: '735a66afc8ffb20ebd91064e2417f3fd7a225eaa', class: {
                'checkbox-container': true,
                'row-layout': this.direction === 'row',
            } }, h("slot", { key: 'b60868dae49bfe14593be563bd8c66d5f7a2ecb2' })))));
    }
