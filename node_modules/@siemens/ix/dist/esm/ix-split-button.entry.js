...
const SplitButton = class {
    ...
    render() {
        ...
        return (h(Host, { key: '19826292e6c9ff936a98a3473876358ee494e958' }, h("div", { key: '160d9320fc3342f32e7b2b7fc370d9fdfc01f0e8', class: { 'btn-group': true, 'middle-gap': !this.outline } }, this.label ? (h("ix-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e) }), this.label)) : (h("ix-icon-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e), "aria-label": this.ariaLabelButton }))), h("ix-icon-button", Object.assign({ key: 'fef7824c8a6cc5a714e1e719b667465be662b9ad' }, buttonAttributes, { ref: (r) => (this.triggerElement = r), class: 'anchor', icon: (_a = this.splitIcon) !== null && _a !== void 0 ? _a : iconContextMenu, "aria-label": this.ariaLabelSplitIconButton }))), h("ix-dropdown", { key: 'e962aac26d428a4ddaf38bcabfdee6f58a06447b', ref: (r) => (this.dropdownElement = r), closeBehavior: this.closeBehavior }, h("slot", { key: '5be0878bd0919b42cbc8ba8572e1a74e218d03ec' }))));
    }
