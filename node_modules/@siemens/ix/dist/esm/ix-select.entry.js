...
import { C as iconPlus, j as iconClear, q as iconChevronUpSmall, f as iconChevronDownSmall } from './index-CB6MK0tq.js';
import { a as a11yBoolean } from './a11y-Bb7pDeaQ.js';
import { A as ArrowFocusController } from './focus-BAKpVknt.js';
import { H as HookValidationLifecycle } from './validation-C17ol6-l.js';
import { O as OnListener } from './listener-C3U9b2OI.js';
...
const Select = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2d5543ec2510c966d5350b5ec49c1d5c51d6e6ed', "aria-disabled": a11yBoolean(this.disabled), class: {
            ...
            } }, h("div", { key: 'd7f983594c4e5d7c144410c5ee2b90e230513bee', class: "input-container" }, h("div", { key: '5d3e7cc757c51fc13d8dac43a8f2c2d771117f9e', class: "chips" }, this.isMultipleMode
            ...
            : '', h("div", { key: '011f79fe57df7045a1ed04a8734b2908da9066cc', class: "trigger" }, h("input", { key: '85c002df772e42f5f100a6f16f310879338b71b7', autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
            ...
            (((_d = this.selectedLabels) === null || _d === void 0 ? void 0 : _d.length) || this.inputFilterText) ? (h("ix-icon-button", { key: "clear", class: "clear", icon: iconClear, ghost: true, oval: true, size: "16", onClick: (e) => {
                ...
                e.stopPropagation();
                this.clear();
            }, "aria-label": this.ariaLabelClearIconButton })) : null, this.disabled || this.readonly ? null : (h("ix-icon-button", { "data-select-dropdown": true, key: "dropdown", class: { 'dropdown-visible': this.dropdownShow }, icon: this.dropdownShow
                ? iconChevronUpSmall
                : iconChevronDownSmall, ghost: true, ref: (ref) => {
                if (this.editable)
                    this.dropdownWrapperRef(ref);
