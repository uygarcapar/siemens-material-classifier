...
:host(.left-pane-border) {
  border-right: var(--theme-app-header--border-width) solid var(--theme-color-soft-bdr);
}

:host(.right-pane-border) {
  border-left: var(--theme-app-header--border-width) solid var(--theme-color-soft-bdr);
}

:host(.top-pane-border) {
  border-bottom: var(--theme-app-header--border-width) solid var(--theme-color-soft-bdr);
}

:host(.bottom-pane-border) {
  border-top: var(--theme-app-header--border-width) solid var(--theme-color-soft-bdr);
}
