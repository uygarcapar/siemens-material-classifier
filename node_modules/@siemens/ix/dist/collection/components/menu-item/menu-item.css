...
:host {
  ...
  display: block;
  cursor: pointer;
  height: var(--ix-menu-item-height, 3rem);
  min-height: var(--ix-menu-item-height, 3rem);
  max-height: var(--ix-menu-item-height, 3rem);
}
:host .tab {
  all: unset;
...
:host(.tab-nested) .tab .notification {
  position: relative;
  top: 0;
  left: 0;
  padding-left: 0.5rem;
}
:host(.tab-nested) .tab .tab-icon {
  padding-left: 0.5rem;
  padding-right: 0.5rem;
}
:host(.tab-nested) .tab .tab-text {
  margin-left: 0.5rem;
}
:host(.tab-nested) .tab::before {
  display: none;
}