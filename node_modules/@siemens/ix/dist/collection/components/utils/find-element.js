 ...
 */
export async function resolveSelector(selector, hostElement) {
 ...
 */
export function getRootFor(element, parent = document.body) {
...
export function waitForSelector(selector, node = document, hostElement) {
 ...
 */
export function findElement(element, hostElement) {
