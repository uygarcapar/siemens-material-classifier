...
:host .btn-search:not(.disabled):not(:disabled) {
  cursor: pointer;
}
:host .btn-search:not(.disabled):not(:disabled):hover, :host .btn-search:not(.disabled):not(:disabled).hover {
  border-color: transparent;
}
:host .btn-search:not(.disabled):not(:disabled) {
  cursor: pointer;
}
:host .btn-search:not(.disabled):not(:disabled):active, :host .btn-search:not(.disabled):not(:disabled).active {
  border-color: transparent;
}
...
:host .btn-search.btn-search--expanded {
  margin-left: 0.25rem;
  pointer-events: none;
}
:host .btn-search:active {
  width: 2rem;
  height: 2rem;
  border-radius: var(--theme-input--border-radius);
...
:host(.right-position.fullWidth) .fullWidth {
  width: 100% !important;
}