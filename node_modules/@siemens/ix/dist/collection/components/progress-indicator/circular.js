...
export const CircularProgress = (props, children) => {
    ...
    return (h("div", { class: {
        ...
        } }, h("svg", { width: sizeInPixel, height: sizeInPixel, viewBox: `-${sizeInPixel * 0.125} -${sizeInPixel * 0.125} ${sizeInPixel * 1.25} ${sizeInPixel * 1.25}`, version: "1.1", xmlns: "http://www.w3.org/2000/svg", style: { transform: 'rotate(-90deg)' } }, h("circle", { r: radius, cx: radius, cy: radius, fill: "transparent", stroke: "var(--theme-color-component-4)", "stroke-width": `3px` }), percentage > 0 && (h("circle", { r: radius, cx: radius, cy: radius, stroke: "var(--ix-progress-indicator-color)", "stroke-width": "3px", "stroke-dashoffset": `${percentage}px`, fill: "transparent", "stroke-dasharray": `${circumference}px` })), h("foreignObject", { x: `0px`, y: `0px`, width: `${sizeInPixel}px`, height: `${sizeInPixel}px`, style: {
