...
var HeaderCellComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react14.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_ag_grid_community12._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef || !isAlive) {
      return;
    }
    const compProxy = {
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react11.useCallback)((eRef) => {
    eGui.current = eRef;
    gridCtrlRef.current = eRef ? context.createBean(new import_ag_grid_community9.GridHeaderCtrl()) : context.destroyBean(gridCtrlRef.current);
    if (!eRef)
      return;
    const compProxy = {
      addOrRemoveCssClass: (name, on) => setCssClasses((prev) => prev.setClass(name, on)),
...
var GridBodyComp = () => {
  ...
  const setRef2 = (0, import_react10.useCallback)((eRef) => {
    ...
    addComp(eRef, import_ag_grid_community8.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    addComp(eRef, import_ag_grid_community8.OverlayWrapperComponent, " AG Overlay Wrapper ");
    if (eBody.current) {
...
var GridComp = ({ context }) => {
  ...
  const setRef2 = (0, import_react9.useCallback)((eRef) => {
    ...
    gridCtrlRef.current = eRef ? context.createBean(new import_ag_grid_community7.GridCtrl()) : context.destroyBean(gridCtrlRef.current);
    ...
    const gridParams = {
      providedBeanInstances: {
        frameworkComponentWrapper: new ReactFrameworkComponentWrapper(
          ...
          mergedGridOps.reactiveCustomComponents ?? (0, import_ag_grid_community._getGlobalGridOption)("reactiveCustomComponents") ?? true
        ),
        renderStatusService
      },
      modules,
      ...
      const checkRowSizeFunc = () => {
        ...
        if (clientHeight != null && clientHeight > 0) {
          const updateRowHeightFunc = () => {
            ...
            if ((0, import_ag_grid_community._isClientSideRowModel)(gos) || (0, import_ag_grid_community._isServerSideRowModel)(gos)) {
