...
var CellComp = ({
  ...
  const setRef2 = (0, import_react17.useCallback)((eRef) => {
    eGui.current = eRef;
    compBean.current = eRef ? context.createBean(new import_ag_grid_community13._EmptyBean()) : context.destroyBean(compBean.current);
    if (!eRef || !cellCtrl) {
      return;
    }
    const compProxy = {
...
var RowContainerComp = ({ name }) => {
  ...
  const containerOptions = (0, import_react19.useMemo)(() => (0, import_ag_grid_community15._getRowContainerOptions)(name), [name]);
...
var GridBodyComp = () => {
  ...
  const setRef2 = (0, import_react20.useCallback)((eRef) => {
    ...
    addComp(eRef, import_ag_grid_community16.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    addComp(eRef, import_ag_grid_community16.OverlayWrapperComponent, " AG Overlay Wrapper ");
    if (eBody.current) {
...
var GridComp = ({ context }) => {
  ...
  const setRef2 = (0, import_react22.useCallback)((eRef) => {
    ...
    gridCtrlRef.current = eRef ? context.createBean(new import_ag_grid_community18.GridCtrl()) : context.destroyBean(gridCtrlRef.current);
    ...
    const gridParams = {
      providedBeanInstances: {
        frameworkComponentWrapper: new ReactFrameworkComponentWrapper(
          ...
          mergedGridOps.reactiveCustomComponents ?? (0, import_ag_grid_community20._getGlobalGridOption)("reactiveCustomComponents") ?? true
        ),
        renderStatusService
      },
      modules,
...
var DetailCellRenderer = (0, import_react23.forwardRef)((props, ref) => {
  ...
  const parentModules = (0, import_react23.useMemo)(() => import_ag_grid_community20.ModuleRegistry.__getGridRegisteredModules(props.api.getGridId()), [props]);
      ...
      const checkRowSizeFunc = () => {
        ...
        if (clientHeight != null && clientHeight > 0) {
          const updateRowHeightFunc = () => {
            ...
            if ((0, import_ag_grid_community20._isClientSideRowModel)(gos) || (0, import_ag_grid_community20._isServerSideRowModel)(gos)) {
