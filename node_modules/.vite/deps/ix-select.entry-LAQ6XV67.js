import {
  ArrowFocusController
} from "./chunk-X3VCJRR7.js";
import {
  OnListener
} from "./chunk-AKIU5VR4.js";
import {
  HookValidationLifecycle
} from "./chunk-RTIVVRPG.js";
import {
  createMutationObserver
} from "./chunk-DQTPPFK6.js";
import "./chunk-6BRQI6RW.js";
import {
  makeRef
} from "./chunk-ATL3QEA6.js";
import {
  a11yBoolean
} from "./chunk-MIJ7GBYT.js";
import {
  iconChevronDownSmall,
  iconChevronUpSmall,
  iconClear,
  iconPlus
} from "./chunk-TFPX4XAJ.js";
import {
  Host,
  createEvent,
  getElement,
...
var Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "2d5543ec2510c966d5350b5ec49c1d5c51d6e6ed", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "c086f36db5e1d653342ef3d371c92ec87b9c1811", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "f9aa6d394d22beb7ee5c67b1915fd9f055851541", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "d7f983594c4e5d7c144410c5ee2b90e230513bee", class: "input-container" }, h("div", { key: "5d3e7cc757c51fc13d8dac43a8f2c2d771117f9e", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "011f79fe57df7045a1ed04a8734b2908da9066cc", class: "trigger" }, h("input", { key: "85c002df772e42f5f100a6f16f310879338b71b7", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      this.navigationItem = void 0;
    }, onInput: () => this.filterItemsWithTypeahead(), onKeyDown: (e) => this.onKeyDown(e) }), this.allowClear && !this.disabled && !this.readonly && (((_d = this.selectedLabels) === null || _d === void 0 ? void 0 : _d.length) || this.inputFilterText) ? h("ix-icon-button", { key: "clear", class: "clear", icon: iconClear, ghost: true, oval: true, size: "16", onClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.clear();
    }, "aria-label": this.ariaLabelClearIconButton }) : null, this.disabled || this.readonly ? null : h("ix-icon-button", { "data-select-dropdown": true, key: "dropdown", class: { "dropdown-visible": this.dropdownShow }, icon: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, ghost: true, ref: (ref) => {
      if (this.editable)
        this.dropdownWrapperRef(ref);
    }, "aria-label": this.ariaLabelChevronDownIconButton })))))), h("ix-dropdown", { key: "de593717f82c07296530c7f5a5da260ead2f10b2", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "829cbac88cdbd5faf0a69ca6e76a2b90be175f88", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "d2a9971788fc0d8326043ab2759cb6cdba46ea7e", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "bcb682d9c4d6804304add78f51afb91c585594f4", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
...
//# sourceMappingURL=ix-select.entry-LAQ6XV67.js.map
