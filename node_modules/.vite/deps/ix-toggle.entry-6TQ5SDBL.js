...
var Toggle = class {
  ...
  render() {
    ...
    return h(Host, { key: "e3a0e2343aeb80cc6c8caf67d89346a090e76087", class: {
      disabled: this.disabled
    }, onBlur: () => this.ixBlur.emit(), onFocus: () => this.touched = true }, h("label", { key: "ba452f648b014b1ff4a29e4aaa9a64fdf7874b60", class: "wrapper" }, h("button", { key: "a11e6c1b02a462931abe2c202dac1abb781cd302", role: "switch", "aria-checked": a11yBoolean(this.checked), class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, onClick: () => this.onCheckedChange(!this.checked) }, h("div", { key: "a4f2635a0ff547ed6db25aed3a022d13d44b875f", class: "slider" })), h("input", { key: "f56d624c9e9691dc726999957fbbdaf7422e3e8f", type: "checkbox", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, tabindex: 0, "aria-hidden": a11yBoolean(true), "aria-checked": a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), !this.hideText && h("ix-typography", { key: "3ccc5308562c9d3b215926d4473ae1395135afe8", class: "label" }, toggleText)));
  }
...
//# sourceMappingURL=ix-toggle.entry-6TQ5SDBL.js.map
