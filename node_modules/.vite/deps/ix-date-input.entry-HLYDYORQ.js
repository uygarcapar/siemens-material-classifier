...
var DateInput = class {
  ...
  render() {
    ...
    return h(Host, { key: "cbc795f1451bfe157806c24b1850d629296a1a76", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "014dc9aa0b6d307bcd32307f5eba87bd184f2d5c", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "bc1c14bdf020e637d56c4a6bedd6acc3d7714c12", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    } }, h("ix-date-picker", { key: "ded3e2a3217e454cba16f29ff9eb61a27816b89f", ref: this.datepickerRef, format: this.format, locale: this.locale, range: false, from: (_a = this.from) !== null && _a !== void 0 ? _a : "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
...
//# sourceMappingURL=ix-date-input.entry-HLYDYORQ.js.map
