...
import {
  matchBreakpoint
} from "./chunk-HMCTM7HE.js";
import {
  anime
} from "./chunk-K3BBX7B2.js";
import {
  Animation
} from "./chunk-XS7YTZKO.js";
...
var Pane = class {
  ...
  render() {
    return h(Host, { key: "ccb348cc08189ab4d12c45576bd073669c75747e", class: {
    ...
    } }, h("aside", { key: "830ddce2f955899f81beb88da248cd59adfae905", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "8e35e2a417b8383b3db3c24f8dfa74f44233ca18", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "d466367c4222c9817420ef53799cb0065f641e26", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, ghost: true, onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}` }), h("span", { key: "c4319e36594f2fac2a9fd9ccd9387764dea6ce24", class: {
      "title-text": true,
      rotate: !this.expanded && !this.isMobile && this.isLeftRightPane
    } }, this.icon ? h("ix-icon", { size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "e0e4d8f1740599af2b76cf8a149e27ae8ea8d2b8", class: "title-text-overflow" }, h("ix-typography", { key: "4078f401fae7bd30d82de8e9737f2e5e24efffe8", format: "h4" }, this.heading)))), h("div", { key: "0e0129ec68fa31f757586a0dfc7f9319aa0c4f64", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "22f5d01280c39438a91c33cb8a3c4d962628c74d" }))));
  }
  get hostElement() {
...
//# sourceMappingURL=ix-pane.entry-N6P6KAAW.js.map
