...
// node_modules/@siemens/ix/dist/esm/ix-content-header.entry.js
var contentHeaderCss = ":host{display:flex;flex-direction:row;align-items:flex-start;padding:0}:host .titleGroup{display:flex;flex-direction:column;flex:1 1 0}:host .titleGroup .secondary{padding:0.25rem 0}:host .subtitle{margin-top:-0.125rem}:host .backButton{margin-right:0.5rem}:host .buttons{flex:0 0 auto}";
var ContentHeader = class {
  constructor(hostRef) {
...
//# sourceMappingURL=ix-content-header.entry-IA7PXTAH.js.map
