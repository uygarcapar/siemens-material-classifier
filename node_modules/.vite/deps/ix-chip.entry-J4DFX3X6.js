...
var Chip = class {
  ...
  render() {
    ...
    return h(Host, { key: "90d999b25775c9ec6f5cd98417ce98e44e60d4d7", tabIndex: "-1", class: {
      ...
      "with-icon": true
    }, name: this.icon, size: "24", style: this.variant === "custom" ? { color: this.outline ? this.background : this.chipColor } : void 0 }), h("span", { key: "4ce076c7b4842bfda0001d7a8e93952c64d13c47", class: "slot-container" }, h("slot", { key: "8713a2201e364feb0744124fe71a58ec92737b34" }))), isInactive === false && this.closable ? this.getCloseButton() : null), this.getTooltip());
  }
  get hostElement() {
...
//# sourceMappingURL=ix-chip.entry-J4DFX3X6.js.map
