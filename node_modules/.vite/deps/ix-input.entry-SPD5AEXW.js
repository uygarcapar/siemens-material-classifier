...
var Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "b069d91c5aca4f679c93b1d440f6ad48cb28d2af", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "a101bf7a971898a1209b832ee5534ab0a835c493", htmlForLabel: this.inputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "3cbe94c3408fac2409a4ba53d51a9c48c62516cf", class: "input-wrapper" }, h(SlotStart, { key: "813456b81fe7cb3c6630a5366dd8a281bb8cd869", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "f271a11579c1a710a2dd21d6f807c44f7e40dce8", id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
      onInputBlur(this, this.inputRef.current);
      this.touched = true;
    }, ariaAttributes: inputAria }), h(SlotEnd, { key: "ca0be4a9ab7182ef66750d710e2275f9586eb361", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "f1371a3cc2ac0497f8bfa5cc54f82f2c7133c555", color: "color-weak-text", class: {
      "password-eye": true,
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "cb783fa80a4ce1fb46b2f69c81e5ca8eb37137f1", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_a = this.value) !== null && _a !== void 0 ? _a : "").length, "/", this.maxLength)));
  }
...
//# sourceMappingURL=ix-input.entry-SPD5AEXW.js.map
