...
var Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "6d4a31e9e38a5fe37516641ee75612124945c91b", class: {
      disabled: this.disabled,
      error: !!this.error
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("div", { key: "e58c79ce5c5e69e032e107f8d8bf3b71c059b1ad", class: "slider" }, h("div", { key: "95128ef9a92de61cc1f38849fe7fda242820e0fd", class: "track" }, h("div", { key: "7ba199d96572e3e05387b07904e86441ff6d309c", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * 100% - 8px)`
    } }), h("div", { key: "050fdd0b142d02d926162051cbf84f4478700f1f", class: "ticks" }, this.marker ? this.marker.map((markerValue) => {
    ...
    }) : null)), h("input", Object.assign({ key: "f17ebdb08b80303f10d356298e5458f277251a4a", id: "slider", type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), style: {
      ...
      this.showTooltip = false;
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max }, this.a11yAttributes)), h("ix-tooltip", { key: "bf5e72361dbe3729c9dc838704b3dc0b650e1ec1", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), h("div", { key: "73d4d2097a7505f08ae235094fd6c12978f0f142", class: "label" }, h("div", { key: "b788653c9947f2c7ca4e80ad84ecf165a1721455", class: "label-start" }, h("slot", { key: "d81fcc6fe5bb4dc1406679b41cebff0fc86ed2c7", name: "label-start" })), h("div", { key: "8fc3940d3222e836f3e876c4fcae103f65088d98", class: "label-end" }, h("slot", { key: "5eaaae48d04af42733193981029e9a59f5d49b37", name: "label-end" }))), this.error ? h("ix-typography", { class: "label-error", textColor: "alarm" }, this.error) : null);
  }
  get hostElement() {
...
//# sourceMappingURL=ix-slider.entry-Z4XVB5LG.js.map
