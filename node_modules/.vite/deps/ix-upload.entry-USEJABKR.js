...
var Upload = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "290d7288ba9353fbcb6a1932e0c9d579fc6b971b" }, a11y, { "aria-disabled": disabled }), h("div", { key: "e31775cbc624c50f7a57572491d9c0ad15f5eceb", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "42e09e50cfbfaf8a9346954957a6738e4d5fb982" }, h("input", { key: "54058e98899436fee4628e03a2a113d1a09fb6a1", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "f533ee7f7ecad63d2737bfa69e16db13884ed015", "aria-disabled": disabled, outline: true, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
...
//# sourceMappingURL=ix-upload.entry-USEJABKR.js.map
