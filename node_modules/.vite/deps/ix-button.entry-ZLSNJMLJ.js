...
var Button = class {
  ...
  componentDidRender() {
    if (this.submitButtonElement && !this.hostElement.contains(this.submitButtonElement)) {
      this.hostElement.appendChild(this.submitButtonElement);
    }
  }
  dispatchFormEvents() {
    if (this.type === "submit" && this.submitButtonElement && !this.disabled && !this.loading) {
  ...
  render() {
    ...
    return h(Host, { key: "b2e6a2e0a0ef51ee7a489eb3135729877b4f7145", tabindex: this.disabled ? -1 : 0, class: {
      disabled: this.disabled || this.loading
    }, onFocus: () => this.setFocus() }, h(BaseButton, Object.assign({ key: "b4a7bb0d3c1289341cb81a58c9c835b51fc66fe7" }, baseButtonProps), h("slot", { key: "be3260fe8e1c73418a2d9f8ed80b588ff3c760b5" })));
  }
  get hostElement() {
...
//# sourceMappingURL=ix-button.entry-ZLSNJMLJ.js.map
