...
var Radio = class {
  ...
  render() {
    return h(Host, { key: "4352faa97b54bf21ceb349a01761dbdd24ef1440", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", class: {
      disabled: this.disabled,
      checked: this.checked
    }, onBlur: () => this.ixBlur.emit() }, h("label", { key: "03eba555f8607a52c9846fccc61a41a5123bd882" }, h("input", { key: "e7bd349e01540ce6972e978c7e9ed10b4c472725", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, name: this.name, ref: this.inputRef, type: "radio", onChange: () => {
      const ref = this.inputRef.current;
      if (ref) {
        this.setCheckedState(ref.checked);
      }
    } }), h("button", { key: "98cf1af286d7ee5d79cdb636e0eed6aafeaf6c71", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, h("div", { key: "05c0ff1d06a449f95f4ff0d701f604f0c67de87b", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } })), h("ix-typography", { key: "44b9b08400297b5497e72c143d0405f1fdc39ba0", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "70dd4b58d047a51f25cd2e0a54df3ccbc0a971ea" }))));
  }
...
//# sourceMappingURL=ix-radio.entry-S5JXVK2I.js.map
