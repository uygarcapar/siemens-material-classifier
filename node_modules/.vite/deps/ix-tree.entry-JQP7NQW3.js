...
import {
  defaultRefreshTreeOptions,
  renderDefaultItem
} from "./chunk-VS5OPST7.js";
import {
  Host,
  createEvent,
  getElement,
...
// node_modules/@siemens/ix/dist/esm/ix-tree.entry.js
var isNumber = (input) => !Number.isNaN(Number(input));
var addClass = (element, className) => {
  element.classList.add(className);
};
var VirtualList = class _VirtualList {
  static create(element, userProvidedConfig = _VirtualList.defaultConfig) {
    return new _VirtualList(element, userProvidedConfig);
  }
  ...
  static getMaxBrowserHeight() {
    ...
    _VirtualList.mergeStyle(wrapper, {
      position: "absolute",
      height: "1px",
      opacity: 0
    });
    _VirtualList.mergeStyle(fixture, { height: "1e7px" });
  ...
  constructor(element, userProvidedConfig) {
    ...
    this._maxElementHeight = _VirtualList.getMaxBrowserHeight();
  ...
  refresh(element, userProvidedConfig = _VirtualList.defaultConfig) {
    ...
    Object.keys(_VirtualList.defaultConfig).filter((prop) => prop in config).forEach((prop) => {
    ...
    _VirtualList.mergeStyle(element, elementStyle);
    if (scrollContainer) {
      _VirtualList.mergeStyle(config.scrollContainer, { overflow: "auto" });
    }
    const scrollerStyle = {
      opacity: "0",
      position: "absolute",
    ...
    _VirtualList.mergeStyle(scroller, scrollerStyle);
    if (!this._scroller) {
  ...
  _computeScrollHeight() {
    ...
    _VirtualList.mergeStyle(this._scroller, {
      opacity: 0,
      position: "absolute",
      top: "0px",
      [isHorizontal ? "height" : "width"]: "1px",
...
var treeCss = ":host{display:block}";
var Tree = class {
  constructor(hostRef) {
  ...
  render() {
    return h(Host, { key: "0a642ed3a475a8c117ab43fc91804ed6b10d7ed7", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "7154de184c8439c3047277415e78a6d45f6ccc5c" }));
  }
  get hostElement() {
...
//# sourceMappingURL=ix-tree.entry-JQP7NQW3.js.map
